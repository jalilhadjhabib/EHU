...
<body>
    ...
    <div id="logout-frame" class="frame-container">
        ...
        <br>
        <a style="background-color: black;" href="http://127.0.0.1:8000/"class="btn btn-success btn-large" >
                                <span class="fas fa-home"> Accueil</span></a>
        <a style="background-color: black;" href="<?= site_url() ?>" class="btn btn-success btn-large">
