                ...
                <div class="col-xs-12 col-sm-10">
                    <?php
                        echo '
                            ...
                            '?>
                            <a href="http://127.0.0.1:8000/"class="btn btn-success btn-large"style="background-color: black;" >
                                <span class="fas fa-home"> Aller à la page d'accueil</span></a>
                             <?php 
                             echo '  
                            <a href="' . site_url() . '" class="btn btn-success btn-large" style="background-color: black;">
