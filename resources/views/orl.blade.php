...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/orl.css') }}">
  </head>
  <body>
        ...
        <tr>
          <th>
            ...
            <ol class="collapse list-unstyled" id="chirurgie">
              ...
              <li><a href="/orl"class="colorsidedropdown"style="color: red;">►O.R.L</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: MEHADJI Mohamed</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : med-mehadji@gmail.com</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service ORL dispose des structures suivantes : 
      </p>
      <ul>
        <li>Un espace de consultation où sont assurées les consultations ORL de base et les consultations spécialisées (laryngologie, otologie, rhinologie et oncologie) ouvert depuis février 2008.</li>
        <li>Un espace hospitalisation d’une capacité de 30 lits, opérationnel depuis février 2009, avec un taux d’occupation avoisinant les 100%.</li>
        <li>Un espace exploration opérationnel depuis octobre 2009. Il est destiné à assurer les explorations et la prise en charge des malades relevant de la compétence de l’orthophoniste et de l’audioprothésiste.</li>
        <li>Une salle opératoire (salle n°05) située au sein du bloc opératoire, mise à la disposition du service ORL le 1ier juillet 2009.</li>
      </ul>
      <h2><strong>Activités du services</strong></h2>
      <p>
        Les activités développées sont les suivantes :
      </p>
      <ul>
        <li>Consultation.</li>
        <li>Exploration et prise en charge orthophonique</li>
        <li>Chirurgicale</li>
        <li>Hospitalisation</li>
      </ul>
      <h2><strong>Activités consultation</strong></h2>
      <ul>
        <li>Quotidienne (consultation normale 3 fois par semaine).</li>
        <li>Hebdomadaire (consultation spécialisée 2 fois par semaine en otologie, rhinologie, cancérologie, laryngologie). Dans ce cadre, sont examinés les patients ayant transité par la consultation normale et munis de leur dossier complet.</li>
        <li>Un tableau exhaustif de l’activité consultation (provenance des malades, pathologies, âge, et (sexe) mettant en évidence, entre autre, la vocation régionale du service, est annexé à ce document.</li>
        <li>Parallèlement à la consultation, au sein de la même structure, des explorations endoscopiques ainsi que des examens sous microscopes et audiométriques ont été assurées de mars 2008 à novembre 2009 (20 mois).  </li>
      </ul>
      <h2><strong>Activités exploration</strong></h2>
      <p>
        Les explorations sont représentées comme suit :
      </p>
      <ul>
        <li>Examen audiométrique:</li>
        <ul>
          <li>Audiométrie tonale.</li>
          <li>Audiométrie vocale.</li>
          <li>Impédancemétrie.</li>
          <li>Potentiel évoqué auditif.</li>
        </ul>
        <li>Examen pour explorer les vertiges :</li>
        <ul>
          <li>Electronystagmographie.</li>
          <li>Vidéonystagmographie.</li>
        </ul>
        <li>Rhinomanomtrie.</li>
        <li>Examens sous microscope à visée diagnostique et interventionnelle.</li>
        <li>Examens endoscopiques:</li>
        <ul>
          <li>Epipharyngoscopie.</li>
          <li>Nasopharyngoscopie.</li>
          <li>Ponction endosinusienne.</li>
        </ul>
      </ul>
      <h2><strong>Prise en charge orthophonique</strong></h2>
      <p>
        Cette activité est assurée par deux Orthophonistes qui prennent en charge, depuis son installation en janvier 2009, en matière de consultation et de traitement, les pathologies suivantes :
      </p>
      <ul>
        <li>Troubles du langage.</li>
        <li>Troubles de la voix.</li>
        <li>Surdimutité.</li>
        <li>Retard du langage.</li>
        <li>Implant cochléaire.</li>
      </ul>
      <p>
        300 malades ont été retenus par l’orthophoniste dans le cadre de sa consultation hebdomadaire et 3 200 séances de rééducation orthophonique ont été réalisées dans le cadre d’une prise en charge quotidienne des malades.
      </p>
      <h2><strong>Activité chirurgicale</strong></h2>
      <p>
        La salle numéro 05, réservée au service ORL, est occupée quotidiennement par l’équipe médicale depuis le démarrage des activités chirurgicales, le 1er juillet 2009.
      </p>
      <p>
        Les pathologies de l’adulte sont prises en charge en priorité.
      </p>
      <p>
        200 interventions ont étés réalisées du 1er juillet 2009 à ce jour. Elles concernent essentiellement :
      </p>
      <ul>
        <li>Les opérations sur le larynx, notamment laryngectomies totales.</li>
        <li>Les otites chroniques.</li>
        <li>Pathologie rhino-sinusienne (infectieuse et tumorale).</li>
        <li>Les tumeurs cervicales notamment celles de la parotide.</li>
      </ul>
      <h2><strong>Personnels du service</strong></h2>
      <ul>
        <li>Un chef de service.</li>
        <li>Deux maitres assistants.</li>
        <li>Vingt (20) résidents.</li>
        <li>Secrétaire pour administration du service.</li>
        <li>Une secrétaire au niveau des espaces consultation et exploration.</li>
        <li>Une hôtesse d’accueil au niveau de l’hospitalisation.</li>
        <li>Cinq (05) agent d’hygiène reparti au niveau des différents espaces.</li>
        <li>Une surveillante médicale chef.</li>
        <li>Le personnel paramédical reparti au niveau des différents espaces.</li>
      </ul>
    </div>
  </div>
</p>
