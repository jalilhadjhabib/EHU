...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Chirurgie hépatobiliaire</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/hepato.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/hepatobiliaire.png">
          </p>
        </div>
      </section>
      <div class="container">
          ...
          <th>
            ...
            <ol class="collapse list-unstyled" id="chirurgie">
              <div class="col-sm-12">
                ...
                <li><a href="/hepatobiliaire"class="colorsidedropdown"style="color: red;">►Hépatobiliaire</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: BEN MAAROUF NOUREDDINE (Professeur)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 17 34</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : Benmaarouf_noureddine@hotmail.com</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service de chirurgie hepatobiliaire et greffe du foie a été crée par arrêté interministériel du 29 Mai 2004 sur proposition de conseil scientifique de l’E H U O, du ministre de la santé de la population et de la réforme hospitalière dans le cadre de la promotion et le développement de la transplantation d’organe en Algérie, initiée par le président de la république Monsieur Abdelaziz Bouteflika.
      </p>
      <p>
        La capacité du service et de 30 lits comprenant 4 unités qui sont :
      </p>
      <ol>
        <li>Unité de transplantation hépatique.</li>
        <li>Unité de chirurgie hépatobiliaire et pancréatique.</li>
        <li>Unité de chirurgie ambulatoire.</li>
        <li>Unité de recherche clinique.</li>
      </ol>
      <p>
        Le service est intégré dans un pole de références intitulé : pole foie / cancer englobant :
      </p>
      <ul>
        <li>Le service de chirurgie hépatobiliaire et greffe du foie.</li>
        <li>Le service d’hépatogastro-entérologie (unité hépatologie).</li>
        <li>Le service d’imagerie médical (unité de radiologie interventionnelle).</li>
        <li>Le service d’oncologie médical.</li>
        <li>Le service urologie de transplantation rénale et pancréatique.</li>
      </ul>
      <h2><strong>Les lieux</strong></h2>
      <p>
        Le  service CHB occupe le 1 er étage du bloc C d’un bâtiment moderne compose de 3  blocs A B C.le CHB comprend :
      </p>
      <ul>
        <li>02 ailes  d’hospitalisation de 15 lits chacune.</li>
        <li>02 salles de  soins.</li>
        <li>02 chambres  d’isolement et soins intensif.</li>
        <li>01 bloc  administratif.</li>
        <li>01 pharmacie.</li>
        <li>Bureaux.</li>
        <li>Salle de  conférence. </li>
        <li>Salle des  archives</li>
      </ul>
      <h2><strong>Missions</strong></h2>
      <p>
        Une offre de soins hautement spécialisée en chirurgie hépatobiliaire et pancréatique. Le projet médical du service de chirurgie hépatobiliaire est greffe du foie est orienté vers la prise en charge globale des malades atteint de maladies hépatiques, d’une hypertension portale ou de lésions biliaires complexes. Il possède l’ensemble des techniques se rapportant à ces affections et effectue toute la chirurgie des tumeurs du foie, des voies biliaires est du pancréas.
      </p>
      <p>
        La transplantation hépatiques et le projet de service le plus important et pour laquelle la préparation de sa réalisation est en cours.
      </p>
      <h2><strong>Activités</strong></h2>
      <ol>
        <li>Le développement du traitement des tumeurs du foie qu’elles soient primitives ou secondaires en particulier en les traitements chirurgicaux.</li>
        <li>L’amélioration des techniques chirurgicales hépatiques :hépatectomies large ou segmentaires , traitement de l’hypertension portale est l’utilisation de l’échographie per opératoire dans ces différentes situations .la radiologie interventionnelle biliaire et hépatique fait partie intégrante de ces techniques.</li>
        <li>Une meilleure connaissance des pathologies en particulier les maladies rénal, hépatique et leurs relations avec la transplantation hépatique, le cancer de Hile du foie, les carcinomes hépatocellulaires les cancers de la vésicule biliaire.</li>
        <li>Développement de la chirurgie coelioscopique du foie des voies biliaires est du pancréas.</li>
      </ol>
    </div>
  </div>
</p>
