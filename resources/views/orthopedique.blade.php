...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Chirurgie orthopédique</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/orthopedique.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/orthopedique.png">
          </p>
        </div>
      </section>
      <div class="container">
        ...
        <tr>
          <th>
            ...
            <ol class="collapse list-unstyled" id="chirurgie">
              ...
              <a href="/orthopedique"class="colorsidedropdown"style="color: red;">►Orthopédique et Traumatologique</a>
            </li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Pr Bouhadiba Toufik</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 70 55 26</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service de chirurgie orthopédique comprend 30 lits réparti en deux unités d’hospitalisations :
      </p>
      <ul>
        <li>Unité d’hospitalisation traumatologie : permettant un séjour postopératoire pour certains malades opérés au niveau du bloc opératoire du service des urgences médico-chirurgical.</li>
        <img src="/images/img%20traumat.png">
        <li>Unité d’hospitalisation orthopédie : Hospitalisation et séjour postopératoire des malades relevant de la chirurgie programmée.</li>
        <img src="/images/img2%20trau.png">
        <p>
          Le service dispose d’une espace de consultation situé au deuxième étage du bloc des consultations spécialises.
        </p>
      </ul>
      <h2><strong>Personnel médical du service</strong></h2>
      <ul>
        <li>Pr Bouhadiba Toufik :chirurgien orthopédiste : Médecin Chef de service.</li>
        <li>Dr Mahdjoub Hadj Ali BENFODDA : chirurgien orthopédiste : Maitre assistant.</li>
        <li>Dr Mohamed MEKRI : chirurgien orthopédiste : Maitre assistant.</li>
        <li>Dr Samir TEBANI : chirurgien orthopédiste : Maitre assistant.</li>
        <li>Dr Azzedine RACHEK : chirurgien orthopédiste : Maitre assistant.</li>
      </ul>
      <h2><strong>Activités du service</strong></h2>
      <ul>
        <li>Consultation spécialisé : en chirurgie orthopédique dans le cadre du recrutement de malades pour la chirurgie programmé.</li>
        <li>Consultation post-opératoire : dans le cadre suis suivie des malades opérés.Activités chirurgical.</li>
        <li>Traumatologie d’urgence : Prise en charge des malades hospitalisés dans le cadre de l’urgence au niveau du service des urgences médico-chirurgical :</li>
        <ul>
          <li>Ostéosynthèsesdes fracture.</li>
          <li>Réparation tendineuse.</li>
          <li>Repartions nerveuses et micro chirurgie.</li>
          <li>Repartions des partie molle de l’appareil locomoteur autre que les nerfs et tendent.</li>
        </ul>
        <li>Chirurgie programme :  Principales activités :</li>
        <ul>
          <li>Chirurgie des séquelles de traumatisme des membres.</li>
          <li>Chirurgie des tumeurs, bénignes et malignes de l’appareil locomoteur.</li>
          <li>Chirurgie des séquelles des lésions des nerfs périphériques et greffe nerveuse.</li>
          <li>Chirurgie des pertes de substance cutanées : greffe de peau mince, greffe de peau totale, lambeau..</li>
          <li>Chirurgie orthoscopique et reconstruction ligamentaire du genou.</li>
          <li>Chirurgie arthroplastique de la hanche et du genou.</li>
          <li>Chirurgieréparatricedes malformations congénitales et acquise de l’appareil locomoteur..</li>
        </ul>
      </ul>
    </div>
  </div>
