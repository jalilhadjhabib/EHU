...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Chirurgie Thoracique</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/thoracique.css') }}">
  </head>
  <body>
          ...
          <th>
            ...
            <ol class="collapse list-unstyled" id="chirurgie">
              <div class="col-sm-12">
                ...
                <a href="/thoracique"class="colorsidedropdown"style="color: red;">►Thoracique</a>
              </li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: LACHEHEB Mohamed</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 70 51 07</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : chirurgiethoracique.ehu@gmail.com</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        L’activité principale du service de chirurgie thoracique concerne, la tuberculose, les tumeurs, l’emphysème et la chirurgie cervicale dominée par la chirurgie thyroïdienne. La chirurgie de la tuberculose englobe les séquelles (poumon détruit, dilatation de bronches, aspergillome, ), la tuberculose résistante.
      </p>
      <p>
        La chirurgie du cancer comprend la chirurgie des cancers broncho-pulmonaires qui restent des maladies graves dont la guérison ne peut être obtenue encore aujourd’hui que par la chirurgie, les métastases pulmonaires, les tumeurs du médiastin, les tumeurs de la paroi thoracique.
      </p>
      <p>
        Le service bénéficie de vidéo-médiastinoscopie, de thoracoscopie vidéo-assistée qui permettent des gestes diagnostics et thérapeutiques sûrs, moins douloureux et diminuant le séjour hospitalier.
      </p>
      <p>
        Ce service a pour mission outre la pathologie thoracique habituelle, de prendre en charge les déformations thoraciques, de développer la chirurgie mini invasive, de prendre en charge la pathologie tracheo-bronchiques par voie chirurgicale classique ou par laser et endoprothèses.
      </p>
      <h2><strong>Équipe médicale</strong></h2>
      <ul>
        <li>Pr LACHEHEB Mohamed chef de service.</li>
        <li>Dr. BOUDIA Amel maitre assistante.</li>
        <li>Dr. BOUSSAFSAF Achour maitre-assistant.</li>
        <li>Dr HALLAB Meriem maitre-assistant.</li>
        <li>Dr. SMAHILI Mohamed assistant.</li>
      </ul>
    </strong>
  </h2>
</div>
