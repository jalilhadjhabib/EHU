...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Cytogénétique et Biologie Moléculaire</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/cytogenetique.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/cytogenetique.png">
          </p>
        </div>
      </section>
      <div class="container">
      ...
      <th>
        ...
        <ol class="collapse list-unstyled" id="analyses">
          <div class="col-sm-15">
            ...
            <li><a href="/cytogenetique"class="colorsidedropdown"style="color: red;">►Cytogénétique et Biologie Moléculaire</a></li>
          </div>
        </ol>
      </th>
    </tr>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Pr M. ABERKANE</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 70 55 20</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : aberkanemeriem@yahoo.fr</strong>
          </h5>
        </li>
      </ul>
      ...
      <img src="/images/img%20cyto.JPG">
      <h2><strong>Missions de l'unité de Cytogénétique</strong></h2>
      <p>
      ...
      <ul>
        <li>Analyse du caryotype constitutionnel pour le diagnostic des anomalies chromosomiques de nombre suivantes : Trisomie 21,18, 13 Syndrome de Turner, Syndrome de Klinefelter, Polysomies X et Y.</li>
        <li>Hybridation In Situ par fluorescence (FISH) en oncohématologie pour la recherche des délétions : p53, CLL (13q14.3 ; ATM ; TP53 ; MYB), ainsi que pour le diagnostic des syndromes suivants:Angelman, Cris du chat, Prader Willi, DI Gorges, et la Neurofibromatose.</li>
      </ul>
      <h2><strong>Missions de l'unité de Biologie Moléculaire</strong></h2>
      <p>
        La principale mission de cette unité est la réalisation dans des conditions qualifiées, des tests moléculaires en cancérologie et en oncohématologie permettant l’accès à des thérapies ciblées. Une validation par une instance Européenne du contrôle de qualité de ces tests (The Network (EMQN)) est en cours.
      </p>
      <p>
      ...
      <ul>
        <li>EGFR.</li>
        <li>Délétions du chromosome Y (YqAZF)</li>
        <li>Duplication du gène FLT3 (ITD)</li>
        <li>Mutation du gène TP53 (Arg72pro)</li>
      </ul>
      <h2><strong>Activités de recherche du service de Cytogénétique et de Biologie Moléculaire</strong></h2>
      <p>
