...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/dermatologie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/dermatologie.png">
          </p>
        </div>
      </section>
      <div class="container">
                ...
                <th>
                  ...
                  <ol class="collapse list-unstyled" id="medecine">
                    <div class="col-sm-12">
                      ...
                      <li><a href="/dermatologie" class="colorsidedropdown"style="color:red;">►Dermatologie</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service : SERRADJ Amina</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 041 53 08 63</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : serradjamina@yahoo.fr</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service de dermatologie se divise en deux poles d'activités médicales. Un pole d'hospitalisation doté de 15 lits, situé au 1ére étage batiment A.
      </p>
      <p>
        Pathologies traitées: toute la dermatologie hospitaliére, en particulier :
      </p>
      <ul>
        <li>Cancers cutanés.</li>
        <li>Maladies bulleuses.</li>
        <li>Toxidermies.</li>
        <li>Psoriasis.</li>
        <li>Plaies chroniques.</li>
        <li>Eczémas.</li>
        <li>Maladies inflammatoires systémiques.</li>
        <li>Génodermatoses.</li>
      </ul>
      <p>
        Un pole de consultation, l'hopital de jour et de traitement spécifique, situé au 2éme étage cote B de la polyclinique. Les consultation sont assurées tous les jours de la semaine sauf le jeudi à partir de 9h du matin.
      </p>
      <h4>Unités :</h4>
      <ul>
        <li>Dermatologie spécialisé.</li>
        <li>Dermatologie interventionnelle et de photothérapie.</li>
        <li>Oncodermatologie.</li>
      </ul>
      <h4>Actes et examens pratiqués :</h4>
      <ul>
        <li>Dermoscopie.</li>
        <li>Chirurgie dermatologique (biopsies, petite chirurgie)</li>
        <li>Cryothérapie, cryochirurgie.</li>
        <li>Photothérapie.</li>
        <li>Chimiothérapie.</li>
        <li>Biothérapies.</li>
      </ul>
      <h4>Missions cliniques :</h4>
      <ul>
        <li>Prendre en charge sur les plans diagnostics et thérapeutiques les patients atteint de maladies de la peau, des muqueuses et des phanères (cuir chevelu et ongles), y compris les infections sexuellement transmissibles.</li>
        <li>Superviser les examens de laboratoires en lien avec la pathologie dermatologique.</li>
        <li>Les patients peuvent etre hospitalidés ou suivi en ambulatoire.</li>
        <li>Poursuite de la spécialisation et l'intégration en équipe thématique du personnel médical et paramédical pour optimiser la prise en charge des patients.</li>
      </ul>
      <h4>Les consultation sont thématiques IST et assurées par:</h4>
      <ul>
        <li>
          <strong>Dimanche :</strong>
          <a> DR DELLI - DR ElOSMANI</a>
        </li>
        <li>
          <strong>Lundi :</strong>
          <a> DR MOKRANI - DR ZAIDI - DR BOUKHALFA</a>
        </li>
        <li>
          <strong>Mardi :</strong>
          <a> DR SERRADJ - DR ABI AYAD - DR TALEB - DR BADANI</a>
        </li>
        <li>
          <strong>Mercredi :</strong>
          <a> DR SALEH - DR ELKHIROU - Dr BENGUELLA</a>
        </li>
      </ul>
    </div>
  </div>
