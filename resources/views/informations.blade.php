...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/informations.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/informations.png">
          </p>
        </div>
      </section>
      <div class="container">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="col-sm-8">
                        <p>
                          L’EHU d' Oran accorde une importance tout à fait particulière à l’aspect social de son image, de ce faite, il a mis en place ce qui suit :
                        </p>
                        <tr>
                          <td width="94%" height="194" align="right" valign="top">
                            <div align="justify">
                              <table width="100%" border="0" cellpadding="10">
                                <tr>
                                  <td width="49%" align="left">
                                    <p align="justify" class="Style22">
                                      <strong>Un bureau postal</strong>
                                      &nbsp;
                                    </p>
                                    <p align="justify" class="Style22" >
                                      <span class="text" style="font-size: 16px;">Afin  d’éviter le déplacement du pérsonnel de l’EHU, lors des versements mensuels,  vers des structures externes, ainsi lui faciliter une opération souvent  contraignante, tout en lui faisant gagner un temps considérable servant au bon  fonctionnement de l’établissement. </span>
                                    </p>
                                  </td>
                                  <td width="51%" align="left" valign="top" class="img">
                                    <img src="/images/postep.jpg" width="250" height="150" alt="La poste à l'EHU" />
                                  </td>
                                </tr>
                              </table>
                            </div>
                              ...
                              <table width="100%" border="0" cellpadding="10">
                                <tr>
                                  <td width="49%" align="left" valign="top">
                                    <strong class="Style22">Un  restaurant&nbsp;</strong>
                                    <br />
                                    <span class="text"><strong></strong>En self-service, il assure des  repas quotidiens à l’ensemble du personnel, y compris les étudiants de l’école  paramédicale.</span>
                                  </td>
                                  <td width="51%" valign="top" class="img">
                                    <img src="/images/cuisinec.jpg" width="250" height="150" alt="Restauration a l'EHU" />
                                  </td>
                                </tr>
                              </table>
                            </div>
                        ...
                        <tr>
                          <td height="99">
                            <div align="justify">
                              <table width="100%" border="0" cellpadding="10">
                                <tr>
                                  <td width="49%" height="170" align="left" valign="top">
                                    <div align="justify">
                                      <strong class="Style22">Une  cafétéria&nbsp;</strong>
                                      <br />
                                      <span class="text">Un coin de détente, ouvert à ceux qui souhaiteraient, quelque fois, se  réunir au tour d’une tasse de café afin de casser le rythme de la journée.</span>
                                    </div>
                                  </td>
                                  <td width="51%" align="left" valign="top" class="img">
                                    <div align="left">
                                      <img src="/images/cafeteria.jpg" width="250" height="150" />
                                    </div>
                                  </td>
                                </tr>
                              </table>
                        ...
                        <tr>
                          <td height="76" valign="top">
                            <table width="100%" height="600" border="0" cellpadding="10">
                              <tr>
                                <td height="183">
                                  <strong class="Style22">Une  confiserie</strong>
                                </td>
                                <td>
                                  <p class="img">
                                    <img src="/images/confiserie.jpg" alt="Une parfumerie et une confiserie" width="250" height="150" align="middle" />
                                  </p>
                                </td>
                              </tr>
                              <tr>
                                <td width="49%" height="199">
                                  <span class="Style22"><strong>Une  parfumerie </strong></span>
                                </td>
                                <td width="51%">
                                  <p class="img">
                                    <img src="/images/parfumeri.jpg" alt="Une parfumerie et une confiserie" width="250" height="150" align="middle" />
                                  </p>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <strong class="Style22">Une  crèche&nbsp;</strong>
                                  <br />
                                  <span class="text">Pour ceux qui  souhaiteraient avoir leurs enfants près d’eux, ainsi, êtres rassurés, et avoir  pour seul soucis, le confort du malade. </span>
                                </td>
                                <td class="img">
                                  <img src="/images/creche.jpg" width="250" height="150" />
                                </td>
                              </tr>
                            </table>
                          </td>
