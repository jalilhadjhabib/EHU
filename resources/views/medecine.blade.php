...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/medecine.css') }}">
  </head>
  <body>
        ...
        <div class="row">
          <div class="col-sm-3">
            <table class="table">
              <tr>
                <th>
                  <a href="#medecine" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle" style="color: red;">Médecine</a>
    ...
    <div class="col-sm-8">
      <h2><strong>Médecine</strong></h2>
      <ul>
        <a href="/cardiologie"><li>Cardiologie</li></a>
        <a href="/dermatologie"><li>Dermatologie</li></a>
        <a href="/endocrinologie"><li>Endocrinologie / Diabétologie</li></a>
        <a href="/medecinepreventive"><li>Epidémiologie / Médecine préventive</li></a>
        <a href="/gastro_enterologie"><li>Gastro entérologie</li></a>
        <a href="/hematologie"><li>Hématologie</li></a>
        <a href="/medecine_de_travail"><li>Médecine de travail</li></a>
        <a href="/medecine_interne"><li>Médecine interne</li></a>
        <a href="/medecine_legale"><li>Médecine légale</li></a>
        <a href="/medecine_physique"><li>Médecine physique et Réadaptation</li></a>
        <a href="/nephrologie"><li>Néphrologie / Maladies des reins</li></a>
        <a href="/neurophysiologie"><li>Neurophysiologie</li></a>
        <a href="/pneumologie"><li>Pneumologie</li></a>
        <a href="/reanimation_medicale"><li>Réanimation médicale</li></a>
        <a href="/oncologie"><li>Oncologie</li></a>
        <a href="/neurologie"><li>Neurologie</li></a>
        <a href="/reanimation_pediatrique"><li>Réanimation pédiatrique</li></a>
      </ul>
    </div>
  </div>
</p>
