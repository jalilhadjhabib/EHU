...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/hemobiologie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/hemobiologie.png">
          </p>
        </div>
      </section>
      <div class="container">
      ...
      <th>
        ...
        <ol class="collapse list-unstyled" id="analyses">
          <div class="col-sm-15">
            ...
            <li><a href="/hemobiologie "class="colorsidedropdown"style="color: red;">►Hémobiologie</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Dr CHEKKAL Mohamed (Maitre de conférences)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : chekkal.mohamed@hotmail.fr</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <ul>
        <li>Unité d’hémostase et thrombose.</li>
        <li>Unité d’exploration cellulaire(Chef d’unité : Dr BENNAOUM Mohamed Nazim)</li>
        <li>Unité d’exploration des hémoglobinopathies(Chef d’unité : Dr ADDA Afaf)</li>
        <li>Unité d’hémobiologie des urgences.</li>
      </ul>
      <h2><strong>Missions</strong></h2>
      <ul>
        <li>Situé au 2ème étage du plateau médico- technique avec une unité délocalisée aux UMC, le service d’hémobiologie assure des prestations de routine et d’urgence 24h/24 et 7j/7.</li>
        <li>Assure l’exploration des syndromes hémorragiques et thrombotiques ainsi que les pathologies du globule rouge notamment celles de l’hémoglobine, les enzymopathies érythrocytaires et les anomalies de la membrane du globule rouge.</li>
        <li>Etude cytologique des éléments du sang, de la moelle osseuse, des adénopathies et de différents liquides biologiques.</li>
        <li>Assurance qualité.</li>
      </ul>
      <h2><strong>Activité actuellement réalisée</strong></h2>
      <table width="850" border="1" align="left" cellpadding="2" cellspacing="0" bordercolor="#CC6699" class="text">
        <tr>
          <td width="187" valign="top">
            <p align="left">
              <strong>  Unité d’hémostase et thrombose </strong>
            </p>
          </td>
          <td width="151" valign="top">
            <p>
              <strong>Unité d’exploration cellulaire </strong>
            </p>
          </td>
          <td width="161" valign="top">
            <p>
              <strong>Unité d’hémobiologie des urgences </strong>
            </p>
          </td>
          <td width="208" valign="top">
            <p>
              <strong>Unité d’exploration d’hémoglobinopathies </strong>
            </p>
          </td>
        </tr>
        <tr>
          <td width="187" valign="top">
            <ul>
              <li><span dir="ltr"></span>Taux de Prothrombine (TP)</li>
              <li><span dir="ltr"></span>Temps de céphaline activé (TCA)</li>
              <li><span dir="ltr"></span>Dosage du fibrinogène (Fib)</li>
              <li><span dir="ltr"></span>Dosage du FII de la coagulation</li>
              <li><span dir="ltr"></span>Dosage du FV de la coagulation</li>
              <li><span dir="ltr"></span>Dosage du FVII de la coagulation</li>
              <li><span dir="ltr"></span>Dosage du FX de la coagulation</li>
              <li><span dir="ltr"></span>Dosage du FIX de la coagulation</li>
              <li><span dir="ltr"></span>Dosage du FXII de la coagulation</li>
              <li><span dir="ltr"></span>Dosage du FXIII</li>
              <li><span dir="ltr"></span>Dosage de la protéine C</li>
              <li><span dir="ltr"></span>Dosage de la protéine S</li>
              <li><span dir="ltr"></span>Dosage de l’antithrombine</li>
              <li><span dir="ltr"></span>Recherche de la résistance à la protéine C activée</li>
              <li><span dir="ltr"></span>Recherche des anticorps antiphospholipides lupiques</li>
              <li><span dir="ltr"></span>Recherche des anticoagulants circulants</li>
              <li><span dir="ltr"></span>Dosage des D dimères</li>
              <li><span dir="ltr"></span>Dosage du facteur de Von Willebrand</li>
              <li><span dir="ltr"></span>Bilan de CIVD</li>
              <li><span dir="ltr"></span>Surveillance biologique des patients sous AVK</li>
            </ul>
          </td>
          <td width="151" rowspan="5" valign="top">
            <ul>
              <li><span dir="ltr"></span>Numération Formule Sanguine (NFS) </li>
              <li><span dir="ltr"></span>Vitesse de sédimentation</li>
              <li><span dir="ltr"></span>Frottis de sang périphérique (FSP)</li>
              <li><span dir="ltr"></span>Médullogrammes</li>
              <li><span dir="ltr"></span>Adénogrammes</li>
              <li><span dir="ltr"></span>Cytologie du Liquide Céphalo-rachidien</li>
              <li><span dir="ltr"></span>Cytologie du liquide d’ascite</li>
              <li><span dir="ltr"></span>Recherche des schizocytes </li>
            </ul>
          </td>
          <td width="161" rowspan="3" valign="top">
            <ul>
              <li><span dir="ltr"></span>NFS</li>
              <li><span dir="ltr"></span>FSP</li>
              <li><span dir="ltr"></span>Numération Formule sanguine</li>
              <li><span dir="ltr"></span>TP</li>
              <li><span dir="ltr"></span>TCA</li>
              <li><span dir="ltr"></span>Fib</li>
            </ul>
            <p>
              &nbsp;
            </p>
          ...
          <td width="208" rowspan="5" valign="top">
            <ul>
              <li><span dir="ltr"></span>Elecectrophorèse de l’hémoglobine</li>
              <li><span dir="ltr"></span>Test de solubilité </li>
              <li><span dir="ltr"></span>Test de résistance globulaire</li>
              <li><span dir="ltr"></span>Test de Cryo hémolyse</li>
              <li><span dir="ltr"></span>Recherche de corps de Heinz</li>
              <li><span dir="ltr"></span>Recherche d’inclusions érythrocyataires </li>
              <li><span dir="ltr"></span>Recherche d’anomalies morphologiques des globules rouges</li>
            </ul>
            <p>
              &nbsp;
            </p>
