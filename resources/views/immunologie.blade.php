...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/immunologie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/immunologie.png">
          </p>
        </div>
      </section>
      <div class="container">
      ...
      <th>
        ...
        <ol class="collapse list-unstyled" id="analyses">
          <div class="col-sm-15">
            ...
            <li><a href="/immunologie"class="colorsidedropdown"style="color: red;">►Immunologie</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Dr BOUALI YOUCEF Youcef</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 18 12</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : yboualiy@yahoo.fr</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service d’immunologie dans une structure hospitalo-universitaire est le maillon central des services biologiques et médicaux. Il contribue à la prise en charge des malades et ouvre des perspectives thérapeutiques. Tout progrès acquis par lui est acquis pour les autres services.
      </p>
      <p>
        À l’EHU Oran, le développement du service d’immunologie est une nécessité pour la société et une obligation pédagogique et scientifique. Cette nécessité est traduite par le fait que le service d’immunologie de l’EHU Oran est le seul service qui existe actuellement dans tout l’ouest du pays et par le manque de spécialistes en immunologie dans les secteurs public et privé dans notre région. Par ailleurs la place qu’occupe l’immunologie actuellement dans le diagnostic des maladies qui sont le plus souvent très  graves et dont le diagnostic précoce et la prise en charge rapide épargnent au malade des complications importantes. D’autant plus l’évolution continue et rapide de l’immunologie ne lui permet d’investir de nouveaux domaines médico- biologiques.
      </p>
      <p>
        Les nations qui projettent le développement doivent investir dans les hommes et cela ne peut se faire que par la formation. Le développement du service d’immunologie permet d’encadrer le personnel médical, paramédical et les étudiants en biologie fondamentale ainsi que de promulguer la recherche scientifique.
      </p>
      <h2><strong>Organisation fonctionnelle du service d’immunologie :</strong></h2>
      <ol>
        <li>Unité d’immunochimie.</li>
        <li>Unité d’auto-immunité.</li>
        <li>Unité d’HLA et culture cellulaire et biologie moléculaire.</li>
        <li>Unité d’allergologie.</li>
      </ol>
      <h2><strong>L’Unité d’immunochimie  assure :</strong></h2>
      <ul>
        <li>Dosage de différentes protéines de liquides biologiques : sériques, urinaires, rachidiennes et du liquide synovial (exemple : immunoglobulines, albumine……)</li>
        <li>Immunoélectrophorèse  et immunofixation  de protéines (sériques, urinaires)</li>
        <li>Immunosélection (recherche des chaînes lourdes libres)</li>
        <li>Immunoelectroquantification (dosage du C3d …)</li>
        <li>Electrophorèse de protéines (sériques, rachidiennes et urinaires)</li>
        <li>Immunoelectofocalisation du LCR.</li>
      </ul>
      <h2><strong>L’Unité d’auto-immunité  assure :</strong></h2>
      <ul>
        <li>Recherche  des auto-anticorps anti antigènes  cellulaires et tissulaires.</li>
        <li>Recherche des autos anticorps anti antigènes solubles.</li>
        <li>Préparation de supports antigéniques (coupes tissulaires, antigènes solubles)</li>
      </ul>
      <h2><strong>L’Unité d’HLA, de la culture cellulaire et biologie moléculaire assure:</strong></h2>
      <ul>
        <li>Typage HLA  par la micro- lymphocytotoxicité.</li>
        <li>Typage HLA par les techniques génétiques (biologie moléculaire)</li>
        <li>Recherche et identification des anticorps anti HLA classe I et classe II.</li>
        <li>Cross Match.</li>
        <li>Culture des cellules pour des études immunologiques et immunogénétiques.</li>
        <li>Conservation de cellules.</li>
        <li>Préparation des supports antigéniques cellulaires.</li>
        <li>Exploration de déficits immunitaires cellulaires.</li>
        <li>Exploration génétique des immunopathies.</li>
      </ul>
      <h2><strong>L’Unité d’Allergologie assure :</strong></h2>
      <ul>
        <li>Dosage des IgE totales.</li>
        <li>Dosage des IgE spécifiques.</li>
        <li>Dosage des médiateurs chimique d’allergie.</li>
        <li>Tests de dé granulation.</li>
      </ul>
      <h2><strong>Activités développées actuellement</strong></h2>
      <table width="707" border="1" align="left" cellpadding="2" cellspacing="0" bordercolor="#CC6699" class="text">
        <tr>
        ...
        <tr>
          <td width="187" valign="top">
            <ul>
              <li><span dir="ltr"></span>Typage(HLAI &amp;HLAII)</li>
            </ul>
            <ul>
              <li><span dir="ltr"></span>Crossmatch</li>
            </ul>
            <ul>
              <li><span dir="ltr"></span>HLAB 27 et HLA B51</li>
            </ul>
          </td>
          <td width="151" rowspan="5" valign="top">
            ...
            <ul>
              <li><span dir="ltr"></span>Nucléaire </li>
              <li><span dir="ltr"></span>DNA</li>
              <li><span dir="ltr"></span>Musclelisses </li>
              <li><span dir="ltr"></span>Mitochondrie</li>
              <li><span dir="ltr"></span>LKM1</li>
              <li><span dir="ltr"></span>LC1</li>
              <li><span dir="ltr"></span>Cellpariétales</li>
              <li><span dir="ltr"></span>Mbranebasale </li>
              <li><span dir="ltr"></span>Substanceinter ¢aire </li>
              <li><span dir="ltr"></span>Endomysium</li>
              <li><span dir="ltr"></span>Gliadine </li>
              <li><span dir="ltr"></span>Transglutaminase</li>
              <li><span dir="ltr"></span>Histone </li>
              <li><span dir="ltr"></span>ANCA</li>
              <li><span dir="ltr"></span>ASCA</li>
              <li><span dir="ltr"></span>PR3</li>
              <li><span dir="ltr"></span>MPO</li>
              <li><span dir="ltr"></span>GBM</li>
              <li><span dir="ltr"></span>CCP </li>
              <li><span dir="ltr"></span>Agsolubles</li>
              <li><span dir="ltr"></span> Thyroglobuline </li>
            </ul>
          </td>
          <td width="161" rowspan="3" valign="top">
            <ul>
              <li><span dir="ltr"></span>Toxo(IgG&nbsp;; IgM)</li>
              <li><span dir="ltr"></span>Rubéole(IgG&nbsp;; IgM)</li>
              <li><span dir="ltr"></span>ASLO</li>
            </ul>
          </td>
          <td width="208" rowspan="5" valign="top">
            <ul>
              <li><span dir="ltr"></span>Immunoglobulines(G, A, M) ,</li>
              <li><span dir="ltr"></span>Complément(C3, C4, C1inh) </li>
              <li><span dir="ltr"></span>Albumine, </li>
              <li><span dir="ltr"></span>Microalbuminurie</li>
              <li><span dir="ltr"></span>Préalbumine&nbsp;</li>
              <li><span dir="ltr"></span>Alpha1antitrypsine</li>
              <li><span dir="ltr"></span>Haptoglobine </li>
              <li><span dir="ltr"></span>Transferrine</li>
              <li><span dir="ltr"></span>Caeruleoplasmine </li>
              <li><span dir="ltr"></span>CRP.</li>
              <li><span dir="ltr"></span>Beta2microglobuline</li>
            </ul>
            <p>
              &nbsp;
            </p>
        ...
        <tr>
          <td width="187" rowspan="3" valign="top">
            <p></p>
            <ul>
              <li><span dir="ltr"></span>Electrophorèsede protéine sérique </li>
              <li><span dir="ltr"></span>Immuno-fixation</li>
              <li><span dir="ltr"></span>Bencejones </li>
              <li><span dir="ltr"></span>Cryoglobuline </li>
            </ul>
            <p>
              <strong>&nbsp;</strong>
            </p>
        ...
        <tr>
          <td width="161" valign="top">
            ...
            <ul>
              <li><span dir="ltr"></span>IgE Totales </li>
              <li><span dir="ltr"></span>IgE  spécifiques </li>
            </ul>
            <p></p>
          </td>
        </tr>
      </table>
      <h2><strong>Perspectives de développement des activités :</strong></h2>
      <ol>
        <h4><li>Développement d’une unité de biologie cellulaire ayant comme objectifs :</li></h4>
        <ul>
          <li>Exploration organique des cellules immunitaires (cytometrie de flux)</li>
          <li>Exploration fonctionnelle  des cellules immunitaires.</li>
          <li>Production des supports antigéniques pour la recherche des auto anticorps anti cellulaires.</li>
        </ul>
        <h4><li>Développement d’une unité de neuro-immunologie</li></h4>
        <ul>
          <li>Iso-électro-focalisation du LCR.</li>
          <li>Dosage des protéines rachidiennes.</li>
          <li>Electrophorèse de protéines rachidiennes.</li>
          <li>Recherche des anticorps spécifiques aux maladies neurologiques.</li>
        </ul>
        <h4><li>Promulgation de la recherche scientifique en immunologie.</li></h4>
      </ol>
    </div>
  </div>
</p>
