...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/cardiologie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/cardiologie.png">
          </p>
        </div>
      </section>
      <div class="container">
              ...
              <tr>
                <th>
                  ...
                  <ol class="collapse list-unstyled" id="medecine">
                    <div class="col-sm-12">
                      <li><a href="/cardiologie" class="colorsidedropdown" style="color:red;">►Cardiologie</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        ...
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 70 55 22</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : cardio.ehuo@gmail.com</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <h4><strong>L'effectif présent</strong></h4>
      <h4>La capacité du service (nombre de lits): 30+08 lits</h4>
      <p>
        Au service d’hospitalisation de cardiologie il y a deux (02) unités, unité « hommes » de (15 lits) et unité «femmes» de (15 lits.)
      </p>
      <h4>Personnel medical</h4>
      <ul>
        <li>Dr ALI LAHMAR HADJ MOHAMED (Maître de conferences B)</li>
        <li>Dr SEDDIKI FAIROUZ (Maître assistante)</li>
        <li>Dr TAYEB DJILLALI (Maitre assistant)</li>
        <li>Dr HANOUCHE KHADIDJA(Assistante principale en médecine interne)</li>
        <li>Dr KERROUCHE MOHAMED (Maitre assistant)</li>
        <li>Dr BENADIDOU CHAREF (Assistant)</li>
        <li>Dr BELAROUSSI NAWEL (Assistante)</li>
      </ul>
      <h4>Personnel para medical</h4>
      <ul>
        <li>Mme MOUDOUB NADIA (surveillante médicale)</li>
        <li>Mr SI YOUCEF SAID (infirmier chef)</li>
        <li>Melle BOUZEBOUDJA NAWEL (chef d’unité coté femme)</li>
        <li>Mme BOUZID LAMIA (chef d’unité coté homme)</li>
        <li>Mme HADROUG IMENE (Chef d’unité d’exploration et de Tensiologie)</li>
        <li>Mme KARIM ISMAHEN (Chef d’unité de consultation)</li>
        <li>Melle MAHALI AMEL LINDA (Infirmière de Bloc)</li>
        <li>Melle BENHMED MBARKA (Infirmière de Bloc)</li>
        <li>Mme MARRIR DJEMAA (hôtesse)</li>
        <li>Mme ZAAFRANE FOUZIA (hôtesse)</li>
      </ul>
      <h4>Unités du service</h4>
      <ul>
        <li>Unité de soins intensifs cardiologiques : 08 lits.</li>
        <li>Consultation : au RDC du bloc de consultation.</li>
        <li>Exploration et Unité de Tensiologie: au 2ème étage du bloc plateau technique.</li>
        <li>Hospitalisation : au 4ème étage du bloc C.</li>
        <li>Unité de cathétérisme et stimulation cardiaque.</li>
      </ul>
      <h4>Missions</h4>
      <ul>
        <li>Prise en charge hospitalière et ambulatoire de la pathologie cardiovasculaire dans le cadre de l’urgence ou du programme.</li>
        <li>
          Exploration non invasive :
          <ul>
            <li>Echocardiographie doppler transthoracique.</li>
            <li>Echocardiographie doppler transoesophagiennne.</li>
            <li>Echocardiographie doppler de stress.</li>
            <li>Epreuve d’effort.</li>
            <li>Holter ECG et MAPA.</li>
          </ul>
        </li>
      </ul>
      <h4>Activité en salle de cathétérisme</h4>
      <ul>
        <li>Stimulation cardiaque temporaire et définitive mono et double chambre.</li>
        <li>Dilatation mitrale percutanée, stimulation cardiaque multisite et  défibrillateur implantable.</li>
        <li>Apres la réparation de la salle cathétérisme ; coronarographie, angioplastie coronaire, Cathétérisme cardiaque droit et gauche, adulte et pédiatrique ainsi que le développement de la rythmologie interventionnelle.</li>
      </ul>
    </div>
  </div>
</p>
