...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/droits.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/droitsdupatient.png" alt="droitspatient">
          </p>
        </div>
      </section>
      <div class="container">
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <div class="col-sm-8">
                            ...
                            <p>
                              Toute personne a droit à la protection de sa santé et aux soins qu’exige son état de santé, à toutes les étapes de la vie.
                              <p>
                                <p>
                                    ...
                                    <div class="col-sm-10">
                                      <strong>
                                        ...
                                        <p>
                                          ...
                                          <p>
                                            - La dignité professionnelle et l’indépendance scientifique de l’ensemble du personnel.
                                          </p>
                                        </p>
                                      </strong>
                                    </div>
