...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/toxicologie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/toxicologie.png">
          </p>
        </div>
      </section>
      <div class="container">
      ...
      <th>
        ...
        <ol class="collapse list-unstyled" id="analyses">
          <div class="col-sm-15">
            ...
            <li><a href="/toxicologie"class="colorsidedropdown"style="color: red;">►Toxicologie</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Dr N. LACHGUEUR</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 14 87</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : toxico_ehu@hotmail.com</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service de toxicologie se situe au niveau du premier étage du plateau technique coté H.
      </p>
      <p>
        Il comprend 04 unités :
      </p>
      <ul>
        <li>Unité des urgences toxicologiques.</li>
        <li>Unité de toxicologie médico-légale.</li>
        <li>Unité de toxicologie professionnelle et environnementale.</li>
        <li>Unité de toxicologie alimentaire.</li>
      </ul>
      <h2><strong>Missions</strong></h2>
      <ul>
        <li>Urgences toxicologiques</li>
        <ul>
          <li>Confirmation des intoxications présumées individuelles ou collectives de nature connue ou inconnue et évaluation de leur gravité.</li>
          <li>Suivi des cas d'intoxication et contrôle de l'élimination du produit toxique.</li>
          <li>Appréciation de l'efficacité d'un traitement spécifique (traitement antidotal).</li>
          <li>Informations et conseils en cas d'intoxications.</li>
          <li>Recherche, identification et dosage des substances toxiques (médicaments, pesticides, produits ménagers,…) dans les milieux biologiques (sang, urines, liquide de lavage gastrique) et les produits suspects.</li>
        </ul>
        <li>Toxicologie médico-légale</li>
        <ul>
          <li>Expertise toxicologique médico-légale : identification et dosage des substances chimiques présentes dans des milieux biologiques ou non biologiques, ayant causé des accidents mortels et corporels (alcool, stupéfiants…) et divers substances chimiques pouvant être à l' origine de décès.</li>
          <li>Dépistage de la toxicomanie chez les personnes présumées ou à risque : Identification et quantification de la consommation d'alcool et de drogues.</li>
          <li>Surveillance biologique des patients en cure de désintoxication et en cours de sevrage.</li>
        </ul>
        <li>Toxicologie professionnelle et environnementale</li>
        <ul>
          <li>Surveillance biologique des travailleurs exposés professionnellement a des substances toxiques :</li>
          <ul>
            <li>Dosage des métaux et métalloïdes (Plomb, Cadmium, Arsenic …)</li>
            <li>Dosage des solvants (éthanol, méthanol, formaldéhyde …)</li>
            <li>Dosage des pesticides.</li>
          </ul>
          <li>Recherche, identification et dosage des substances toxiques dans les eaux.</li>
          <li>Contrôle des eaux d'hémodialyse.</li>
        </ul>
        <li>Toxicologie alimentaire</li>
        <ul>
          <li>Recherche, identification et dosage des substances toxiques dans les aliments.</li>
          <li>Dosage des additifs alimentaires.</li>
        </ul>
      </ul>
    </div>
  </div>
