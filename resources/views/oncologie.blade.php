...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/oncologie.css') }}">
  </head>
  <body>
          ...
          <div class="col-sm-3">
            <table class="table">
              <tr>
                ...
                <li><a href="/oncologie"class="colorsidedropdown"style="color:red;">►Oncologie </a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Professeur YAMOUNI Mohamed</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : oncolor@yahoo.fr</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Equipe </strong></h2>
      <ul>
        <strong><li>Pr.  BELDJILALI Yamina</li></strong>
        <strong><li>Pr. BESSAIH Nadia</li></strong>
        <strong><li>02 Maitres assistants</li></strong>
        <strong><li>03 assistants Santé publique</li></strong>
        <strong><li>03 Résidents</li></strong>
      </ul>
      <h2><strong>Le Service d’Oncologie Médicale est composé de :</strong></h2>
      <ol>
        <li>Une unité assurant l’activité d’Hôpital de jour avec 20 fauteuils pour traitement des malades cancéreux en ambulatoire (Chimiothérapie, thérapie ciblée, biphosphonates etc.) Cette unité est située au deuxième étage du bloc d’exploration.</li>
        <li>Une unité de consultation et urgence avec 05 lits assurant les consultations et prend en charge les urgences en oncologie (traitement de la douleur, transfusions, ponctions évacuatrices etc.). Cette unité est située au premier étage au bloc des consultations.</li>
      </ol>
      <h2><strong>Missions</strong></h2>
      <ul>
        <li>Santé publique (soins en Oncologie)</li>
        <li>Formation en graduation et post-graduation médicale.</li>
        <li>Formation paramédicale.</li>
        <li>Recherche.</li>
      </ul>
      <h2><strong>Activité</strong></h2>
      <ol>
        <li>Le traitement des malades cancéreux (chimiothérapie, thérapie ciblée, hormonothérapie et immunothérapie)</li>
        <li>Visite quotidienne des malades.</li>
        <li>Suivi des patients.</li>
        <li>Staff des dossiers des patients.</li>
        <li>Réunions de concertation multi disciplinaire.</li>
        <li>Formation des médecins spécialistes.</li>
        <li>Encadrement des résidents.</li>
        <li>Formation du para médical.</li>
        <li>Organisation des journées pour la formation continue.</li>
      </ol>
      <h2><strong>Perspectives de développement</strong></h2>
      <p>
        La création d’un service avec :
      </p>
      <ol>
        <li>Unité d’hospitalisation homme (15 lits)</li>
        <li>Unité d’hospitalisation femme (15 lits)</li>
        <li>Hôpital de jour (20 fauteuils)</li>
        <li>Unité des urgences et traitement de la douleur.</li>
        <li>Unité de consultation spécialisée.</li>
        <li>Unité d’hospitalisation à domicile.</li>
      </ol>
    </div>
  </div>
</p>
