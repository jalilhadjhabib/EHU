    ...
    <nav class="navbar navbar-expand-md">
        ...
        <div class="contest">
          <div class="container">
            <h1 class="jumbotron-heading">
              <strong><br>Contactez-Nous</strong>
            </h1>
          </div>
        </div>
      </section>
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <center>
              <button onclick="document.getElementById('modal1').style.display='block'" class="button">
              ...
              <div id="modal1" class="w3-modal">
                <div class="w3-modal-content w3-animate-top w3-card-4">
                  <header class="w3-container w3-light">
                    ...
                    <h2><strong>Envoyez-nous un message sur :</strong></h2>
                    <br>
                  </header>
                  <div class="w3-container">
                    <a href="https://www.facebook.com/messages/t/EHUDORAN" class="fb btn"target="_blank"><i class="fa fa-facebook fa-fw" ></i>Facebook</a>
                    <a href="https://twitter.com/ehuoran" class="twitter btn"target="_blank"><i class="fa fa-twitter fa-fw"></i>Twitter</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-sm-4">
              <center>
                <button onclick="document.getElementById('modal2').style.display='block'"class="button">
                  ...
                  <div class="w3-modal-content w3-animate-top w3-card-4">
                    <header class="w3-container w3-light">
                      ...
                      <div class="container">
                        ...
                        <div class="row">
                          <div>
                            <form method="post" class="input1" action="/php/contact.php">
                              <label for="fname">Nom</label>
                              <input type="text" id="fname" name="fname" placeholder="Votre Nom.."required>
                              <label for="lname">Prénom</label>
                              <input type="text" id="lname" name="lname" placeholder="Votre Prénom.."required>
                              <label for="email">Email</label>
                              </br>
                              <input type="email" id="email" name="email" placeholder="Votre Email..">
                            </brrequired>
                            <label for="subject">Objet</label>
                            <textarea id="subject" name="subject" placeholder="Votre message.." style="height:170px"required></textarea>
            ...
            <div class="col-sm-4">
              <center>
                <button onclick="document.getElementById('modal3').style.display='block'" class="button">
                ...
                <div id="modal3" class="w3-modal">
                  <div class="w3-modal-content w3-animate-top w3-card-4">
                    <header class="w3-container w3-light">
                      ...
                      <h2><strong>Appelez le Service clientèle :</strong></h2>
                      </br>
                    </header>
                    </br>
                    <div class="w3-container">
                      <ul>
                        <li>(+213) 041 70 50 92</li>
                        <li>(+213) 041 70 50 88</li>
                        <li>(+213) 041 70 50 87</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-2 col-lg-2 col-xl-3 mx-auto">
                  ...
                  <ul class="list-unstyled">
                    <li>
                      <a href="https://www.facebook.com/EHUDORAN" class="fb btn"target="_blank" style="background-color: #4267B2;color: white;width: 70px;"><i class="fa fa-facebook fa-fw fa-2x" style="" ></i></a>
                      <a href="https://twitter.com/ehuoran" class="twitter btn"target="_blank" style="background-color: #38A1F3;color: white;width: 70px;"><i class="fa fa-twitter fa-fw fa-2x"></i></a>
                    </li>
                  </ul>
                </div>
                <div class="col">
                ...
                <a id="topbutton" class="gotopbtn" href="#"><i id="gotopbtn2" class="fas fa-arrow-up"></i></a>
...
mybutton = document.getElementById("gotopbtn2");
