...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/sortie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/sortie.png" alt="droitspatient">
          </p>
        </div>
      </section>
      <div class="container">
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <div class="col-sm-8">
                            <h2><strong>1- Autorisation de sortie en cours d’hospitalisation</strong></h2>
                            <p>
                              Les malades hospitalisés peuvent, lorsque le séjour est prolongé, bénéficier d’une autorisation de sortie à titre exceptionnel pour une durée maximum de 48 heures sur décision du Directeur Général de l’EHUO après avis du  médecin-chef de service. Le bureau des entrées de l’EHUO est avisé et le porte sur les registres de mouvement des malades.
                              <p>
                                <p>
                                  Si un malade ne réintègre pas le service dans les délais impartis, il est porté sortant et ne peut être réadmis que dans le cadre des procédures d’une nouvelle admission.
                                  <p>
                                    <h2><strong>2- Formalités de Sortie de l’hôpital </strong></h2>
                                    <p>
                                    ...
                                    <p>
                                      -Les documents de sorties, indiqués plus haut, en plus de la fiche navette visée par le médecin-chef, ou par le médecin dûment autorisé par lui, et par le surveillant médical du service sont adressés par le service d’hospitalisation chez le  bureau des entrées pour procéder aux formalités de sortie.
                                    </p>
                                    <p>
                                      -En aucun cas, le malade ou les parents du malade, n’ont pas le droit de déposer eux-mêmes ces documents au bureau des entrées.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                      -Le rapport médical et le compte-rendu opératoire, éventuellement, sont délivrés à la demande du malade et n’entrent pas dans le cadre de cette procédure.
                                    </p>
                                    <h2><strong>CAS PARTICULIERS DE SORTIE</strong></h2>
                                    <h4>1- Sortie contre avis médical</h4>
                                    <p>
                                      -Sauf cas où la santé publique est menacée, les malades peuvent, sur leur demande, quitter à tout moment l’EHUO.
                                    </p>
                                    <p>
                                      -Lorsque le malade est mineur ou ne peut faire preuve de discernement lé réglementation en matière de tutelle est appliquée.
                                    </p>
                                    <p>
                                      -Si le médecin traitant juge la sortie prématurée, cette sortie sur décision du malade est assimilée à un refus de soins.
                                    </p>
                                    <p>
                                      Le malade signe alors une décharge consignant sa volonté de sortir contre un avis médical malgré sa connaissance des risques éventuels encourus; en cas de refus de signer cette décharge, un procès-verbal est établi en présence de deux témoins.
                                    </p>
                                    <p>
                                      La modalité de sortie contre l'avis médical est consignée dans le dossier médical, la fiche navette, le Résumé Standardisé de sortie et le résumé clinique de sortie.
                                    </p>
                                    <h4>2- Sortie sans avis médical(fugue du service)</h4>
                                    <p>
                                      Si un malade a quitté l’EHUO sans prévenir, la Direction Générale est informée et des recherches sont aussitôt lancées.
                                    </p>
                                    <p>
                                      Si les recherches sont restées sans succès, la Direction Générale avise les autorités de police de cette disparition.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                      La modalité de sortie contre un avis médical (avec mention «  à l’insu du service ») est consignée dans le dossier médical, la fiche navette, le Résumé Standardisé de sortie et le résumé clinique de sortie.
                                    </p>
                                    <h4>3- Sortie disciplinaire</h4>
                                    <p>
                                    ...
                                    <p>
                                      Dans ce cas, la continuité des soins doit être assurée, sous la responsabilité du service social de l’EHUO, en organisant une alternative dont le malade est informé.
                                    </p>
                                  </div>
                                </div>
                              </p>
