...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/chirurgie.css') }}">
  </head>
  <body>
    ...
    <div class="col-sm-8">
      ...
      <ul>
        <a href="/cardiaque"><li>Chirurgie cardiaque</li></a>
        <a href="/generale"><li>Chirurgie générale</li></a>
        <a href="/hepatobiliaire"><li>Chirurgie hépatobiliaire</li></a>
        <a href="/maxillo_faciale"><li>Chirurgie Maxillo-faciale</li></a>
        <a href="/thoracique"><li>Chirurgie thoracique</li></a>
        <a href="/vasculaire"><li>Chirurgie vasculaire</li></a>
        <a href="/neurochirurgie"><li>Neurochirurgie</li></a>
        <a href="/orl"><li>O.R.L</li></a>
        <a href="/orthopedique"><li>Orthopédie et Traumatologie</li></a>
        <a href="/urologie"><li>Urologie</li></a>
      </ul>
    </div>
  </div>
</p>
