...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Réanimation pédiatrique </title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/reanimation_pediatrique.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/reanimationpediatrique.png">
          </p>
        </div>
      </section>
      <div class="container">
          ...
          <div class="col-sm-3">
            <table class="table">
              <tr>
                ...
                <li><a href="/reanimation_pediatrique"class="colorsidedropdown"style="color:red;">►Réanimation pédiatrique </a></li>
              </ol>
            </th>
          </tr>
        </div>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Batouche Djamila-Djahida</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service d’anesthésie pédiatrique et néonatalogique a ouvert ses portes le 1/10/2016 et a débuté son fonctionnement le 03 janvier 2017 avec un programme anesthésique en neurochirurgie puis ce programme s’est élargi à d’autres spécialité).
      </p>
      <h4>Le service d’anesthésie réanimation pédiatrique et néonatalogique comporte :</h4>
      <ol>
        <h4>
          <strong><li>PLUSIEURS SALLES :</li></strong>
        </h4>
        <ul>
          <li>Une (01) salle n° 1 pour deux (02) nourrissons.</li>
          <li>Deux (02) salles n°2 et 3 pour trois (03) enfants.</li>
          <li>Quatre chambres de soins intensifs (n° 4, 5, 6 ,7) pour accueillir un (01) nouveau-né chacune.</li>
          <li>Une salle de réanimation pour deux (02) nouveau-nés.</li>
        </ul>
        <h4>
          <strong><li>Un espace de surveillance.</li></strong>
        </h4>
        <h4>
          <strong><li>Une pharmacie.</li></strong>
        </h4>
      </ol>
      <h4><strong>Les Stages pratiques avec terrain validant :</strong></h4>
      <ol>
        <li>Réanimation pédiatrique :</li>
        <ul>
          <li>Responsables du terrain : Batouche djamila-djahida (chef de service)</li>
          <li>Boudjahfa Samir MCB (chef d’unité)</li>
          <p>
            Il s’agit de la réanimation médicochirurgicale avec 8 lits.
          </p>
        </ul>
        <li>Réanimation néonatale (avec 6 lits) :</li>
        <ul>
          <li>(responsable et chef d’unité) :TOUHAMI Yasmine (MA)</li>
        </ul>
        <li>Anesthésie pédiatrique (avec une unité individualisée) (unité fonctionnelle)  :</li>
        <ul>
          <li>Responsables du terrain : Tabeliouna kheira (MCA)</li>
          <li>Assistante affectée depuis octobre 2016 : Hakkoum samira.</li>
        </ul>
        <li>Consultation d’anesthésie-réanimation pédiatrique  :</li>
        <p>
          Qui a lieu tous les mardis pour les enfants qui seront programmés au niveau du service.
        </p>
        <strong><li>Activités anesthésiques :</li></strong>
        <p>
          L’Anesthésie se déroule au niveau du bloc central ou au niveau des urgences : Il s’agit d’une activité d’anesthésie pédiatrique quotidienne et variée avec des équipes spécialisées assurant la prise en charge des enfants de 15 jours (exceptionnellement en chirurgie neurochirurgicale) jusqu’à 15 ans.
        </p>
        <p>
          Ces équipes spécialisées comportent des praticiens en anesthésie réanimation pédiatrique, en neurochirurgie, ORL, chirurgie maxillo - faciale, chirurgie thoracique , chirurgie urologique et parfois chirurgie traumatologie. , chirurgie en urgence.
        </p>
      </ol>
      <h2><strong>Dans les perspectives en réanimation pour ce service  :</strong></h2>
      <p>
        Perspectives en ressource humaine qui fonctionnera selon une organisation en roulement par équipe.
      </p>
      <ul>
        <li>03 spécialistes en pédiatrie secondés par les réanimateurs pour prise en charge des nouveaux nés en détresse.</li>
        <li>8 médecins séniors (maitre assistants et assistants) pour la bonne démarche des gardes effectives et un bon rendement de l’activité hospitalière, et ainsi pour une meilleure qualité de vie du réanimateur.</li>
        <li>Un bloc opératoire dédié à l’enfant.</li>
        <li>Une salle de SSPI et d’hospitalisation ambulatoire pédiatrique, avec un personnel médical et paramédical qualifié.</li>
        <li>Un nombre suffisant en AMAR pour assister les médecins en anesthésie réanimation pédiatrique.</li>
        <li>Une Anesthésie ambulatoire chez l’enfant en vue de prélèvement pour une allogreffe de la moelle osseuse.</li>
        <li>Une sédation hors bloc opératoire au niveau du service de radiologie (et de ce fait le service de radiologie doit être équipé d’une source d’oxygène et d’un respirateur mobile)</li>
      </ul>
    </div>
  </div>
</p>
