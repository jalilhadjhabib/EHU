...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/radiologie.css') }}">
  </head>
  <body>
    ...
    <div class="col-sm-8">
      <h2><strong>Radiologie</strong></h2>
      <ul>
        <a href="/imagerie_medicale"><li>Imagerie médicale</li></a>
        <a href="/medecine_nucleaire"><li>Biophysique et médecine nucléaire</li></a>
      </ul>
    </div>
  </div>
</p>
