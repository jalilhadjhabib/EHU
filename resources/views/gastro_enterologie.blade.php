...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/gastro.css') }}">
  </head>
  <body>
                ...
                <th>
                  ...
                  <ol class="collapse list-unstyled" id="medecine">
                    <div class="col-sm-12">
                      ...
                      <a href="/gastro_enterologie"class="colorsidedropdown"style="color:red;">►Gastro entérologie</a>
                    </li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Pr BOUASRIA Hamza</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 70 51 19</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : hbouasria_ehu@hotmail.fr</strong>
          </h5>
        </li>
      </ul>
      ...
      <ul>
        <li>Unité d’hospitalisation de 30 lits située au 2ème étage du Bloc B de l’hospitalisation.</li>
        <li>Unité de Consultations Externes avec Hôpital de jour située au 1er étage du bloc « Consultation».</li>
        <li>Unité d’Endoscopie diagnostiqué et thérapeutique située au 3ème étage au « Plateau Technique ».</li>
        <h4>Missions</h4>
        <p>
        ...
        <h4>Activités</h4>
        <ul>
          <li>Consultation de Gastro-Entérologie.</li>
          <li>Consultation d’Hépatologie.</li>
          <li>Consultation  de Proctologie.</li>
          <li>Prise en charge des hépatopathies chroniques virales (B et C)</li>
          <li>Prise en charge en hôpital du jour de certaines pathologies ;Cirrhose, MICI(Biothérapie).</li>
          <li>Endoscopie diagnostique (haute et basse).</li>
          <li>Endoscopie thérapeutique:ligature de varices oesophagiennes.</li>
          <li>Laparoscopie, Ponction biopsie hépatique.</li>
          <li>Echo-endoscopie basse.</li>
          <li>
            <h5>
              Activité en projet(court terme)
            </h5>
            <ul>
              <li>Exploration (Manométrie, Ph métrie)</li>
              <li>CPRE ; Pose de prothéses.</li>
              <li>Participation au projet de greffe hépatique.</li>
            </ul>
          </li>
          <li>
            <h5>
            ...
            <li>Participation au congrès scientifique nationaux et internationaux.</li>
          </li>
          <li><h5>Projet de recherche sur les hépatopathies chroniques non Virales.</h5></li>
        </ul>
        <h4>Personnel du service</h4>
        <ul>
          <li>Un médecin chef de service : Pr H.BOUASRIA</li>
          <li>Un Professeur : Pr.Manouni</li>
          <li>Un Maitre des conférences</li>
          <li>03 Maitres Assistants</li>
          <li>03 Spécialistes de santé publique</li>
        </ul>
      </ul>
    </div>
  </div>
