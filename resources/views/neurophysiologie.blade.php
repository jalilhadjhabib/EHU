...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/neurophysiologie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/neurophysiologie.png">
          </p>
        </div>
      </section>
      <div class="container">
            ...
            <table class="table">
              <tr>
                <th>
                  ...
                  <a href="/neurophysiologie"class="colorsidedropdown"style="color:red;">►Neurophysiologie </a>
                </li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Dr M.B.HENNIENE</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 53 72 62</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : neurophysioran@gmail.com</strong>
          </h5>
        </li>
      </ul>
      ...
      <ul>
        <li>Laboratoire d’Electro-encéphalographie (EEG).</li>
        <li>Laboratoire d’Electroneuromyographie (ENMG).</li>
        <li>Laboratoire de Potentiels Evoqués (PE).</li>
      </ul>
      <h2><strong>Missions (soins)</strong></h2>
      <p>
      ...
      <ul>
        <li>L’Electroneuromyographie (ENMG) : détecte et évalue les pathologies nerveuses périphériques, musculaires et de la jonction neuromusculaire.</li>
        <li>L’Electroencéphalographie (EEG) : enregistre les activités électriques du cerveau en vu de dépister les épilepsies et évaluer les fonctions de vigilance.</li>
        <li>Les Potentiels Evoqués (PE) étudient les fonctions médullaires et sensorielles ; (Auditifs, Visuels et Somesthésiques).</li>
      </ul>
    </div>
  </div>
</p>
