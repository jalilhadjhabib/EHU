...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/medecine_legale.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/medecinelegale.png">
          </p>
        </div>
      </section>
      <div class="container">
              ...
              <tr>
                <th>
                  ...
                  <ol class="collapse list-unstyled" id="medecine">
                    ...
                    <a href="/medecine_legale"class="colorsidedropdown"style="color:red;">►Médecine légale</a>
                  </li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: ABOUBEKER Abdelmadjid (Médecin légiste)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 17 99</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : ababoubeker@yahoo.fr</strong>
          </h5>
        </li>
      </ul>
      ...
      <ol>
        <h3>
          <li><strong>Accueil des victimes</strong></li>
        </h3>
        <p>
          Les victimes se présente au niveau du service munis d’une réquisition émanant :
        </p>
        <ul>
          <li>Soit de la police judiciaire (gendarmerie ou police).</li>
          <li>Soit du procureur de la république.</li>
        </ul>
        <p>
        ...
        <h4><strong>Consultation de coups et blessures :</strong></h4>
        <ul>
          <li>Coups et blessures volontaires (agressions)</li>
          <li>Coups et blessures involontaires (accident de la voie publique)</li>
          <li>Violence conjugale.</li>
          <li>Violence sur mineurs.</li>
          <li>Attentat sexuel.</li>
        </ul>
        <h4><strong>Consultation et suivi psychologique :</strong></h4>
        <ul>
          <li>Violences conjugales.</li>
          <li>Violence sur mineurs.</li>
          <li>Viol – attentats sexuels – inceste.</li>
        </ul>
        <p>
          La consultation chez le médecin légiste est effectuée au vue de la réquisition.
        </p>
        <h3>
          <li><strong>Consultation des personnes gardées a vue</strong></li>
        </h3>
        <p>
        ...
        <h3>
          <li><strong>Autopsie judiciaire</strong></li>
        </h3>
        <p>
        ...
        <h3>
          <li><strong>Pièces anatomiques, produits innomés</strong></li>
        </h3>
        <p>
        ...
        <h3>
          <li><strong> La levée de corps</strong></li>
        </h3>
        <h3>
          <li><strong>Gardes médico-légales 24/24h</strong></li>
        </h3>
        <h3>
          <li><strong>Expertise civile et expertise pénale</strong></li>
        </h3>
      </ol>
    </div>
  </div>
