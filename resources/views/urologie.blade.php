...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Chirurgie Urologique</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/urologie.css') }}">
  </head>
  <body>
        ...
        <tr>
          <th>
            ...
            <ol class="collapse list-unstyled" id="chirurgie">
              ...
              <li><a href="/urologie"class="colorsidedropdown"style="color: red;">►Urologie</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Yousfi Mostefa Jamel</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 40 220 742</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : ymostafajamal@gmail.com</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service de chirurgie orthopédique et traumatologique est situé au premier étage du bloc B du secteur d’hospitalisation.
      </p>
      <p>
        Le service de Chirurgie Urologique dispose des espaces suivants :
      </p>
      <ul>
        <li>Consultations: au 1er étage du bloc des consultations spécialisées : fonctionnelle depuis mai 2007 :</li>
        <ul>
          <li>Consultations : Uro-oncologie, Endo-urologie, Prinéologie, Uro-pédiatrie, Andrologie, Hypofertilité.</li>
          <li>Hospitalisation du jour.</li>
        </ul>
        <li>Hospitalisation : se situe au 6ème étage du bloc C avec 2 ailes d’une capacité de 30 lits.</li>
        <li>Unité de lithotripsie extracorporelle, d’exploration (Endoscopie, débitmètrie) et d’échographie interventionnelle : se situe au 3ème étage du plateau technique.</li>
        <li>Une salle opératoire située au sein du bloc opératoire central.</li>
        <p>
          Le service est intégré dans le pôle de chirurgie.
        </p>
      </ul>
      <h2><strong>Activités du service</strong></h2>
      <ul>
        <li>Consultation: assurée tous les jours à partir de 08H30mn.</li>
        <li>Exploration: (sur rendez-vous fixé à partir de la consultation).</li>
        <li>Chirurgicale: Tous les jours à partir de 08H à 20H.</li>
        <li>Hospitalisation.</li>
      </ul>
      <p>
        Notre service prend en charge toutes les pathologies de l'appareil urinaire.
      </p>
      <p>
        Voici un résumé de nos principaux secteurs d'activité :
      </p>
      <ul>
        <li>Cancérologie : Tous les cancers urologiques y sont traités, que ce soit le cancer de la prostate, du rein, de la vessie, du testicule ou les tumeurs plus rares, nous coopérons avec plusieurs services d'oncologie et de radiothérapie pour les tumeurs qui relèvent d'une approche multidisciplinaire, pour chaque type de tumeur, nous disposons des techniques conventionnelles mais également de techniques nouvelles et mini-invasives.</li>
        <li>Adénome de la prostate : l'hyperplasie bénigne de la prostate : de nombreux traitements disponibles : La chirurgie ouverte, la résection endoscopique mono polaire et bipolaire.</li>
        <li>Lithiase urinaire : calculs du rein, de l'uretère et de la vessie. Nous utilisons toutes les techniques mini-invasives actuelles (lithotritie extracorporelle, urétéroscopie semi-rigide, souple et chirurgie percutanée).</li>
        <h4><strong>Lithotripsie extra corporelle (LEC)</strong></h4>
        <img src="/images/img1.png">
        <h4><strong>Néphrolithotomie percutané (NLPC)</strong></h4>
        <img src="/images/img2.png">
        <img src="/images/Iimg3.png">
        <li>Statique pelvienne : incontinence urinaire et prolapsus génito-urinaires. Nous disposons de nombreux procédés pour traiter l'incontinence chez la femme. Pour traiter les prolapsus, nous réalisons les interventions par voie classique, par cœlioscopie et par voie vaginale.</li>
        <li>Andrologie: troubles de l'érection, pathologies des organes génitaux.</li>
        <li>Malformations de l'appareil urinaire chez l’enfant et l’adulte.</li>
        <li>Urgences urologiques : assuré au niveau du service des urgences médicochirurgicales (UMC) : nous prenons en charge toutes les urgences médicales, chirurgicales (Chirurgie classique et percutanée pour le drainage échoguidé des urines et des collections).</li>
      </ul>
      <p>
        Notre service est doté de nouvelles technologies faisant appel à des équipements modernes. En voici quelques exemples :
      </p>
      <ul>
        <li><strong>Chirurgie coelioscopique</strong> pour les pathologies rénales, le cancer de la prostate ou le prolapsus génito-urinaire.</li>
        <li>Nouveaux traitements de<strong> l'incontinence urinaire.</strong>(TVT/TOT).</li>
      </ul>
      <p>
        La laparoscopie est une technique de vidéochirurgie qui consiste à introduire une caméra et des instruments par des petits orifices et à faire l'intervention par l'intermédiaire d'un écran.
      </p>
      <p>
        La cœlioscopie évite de faire une ouverture classique, permettant ainsi de réduire les douleurs postopératoires liées à la cicatrice, d’écourter la durée du séjour et de faciliter la convalescence.
      </p>
      <ul>
        <li>Echographie interventionnelle :</li>
        <ul>
          <li>Biopsie prostatique transrectale.</li>
          <li>Néphrostomie percutanée.</li>
          <li>Biopsie rénale.</li>
        </ul>
        <img src="/images/img8.png">
        <li>Le service comprend une unité pour les consultations et l’hospitalisation du jour :</li>
        <ul>
          <li>Les instillations endo-vésicales pour les tumeurs de vessie.</li>
          <li>Les soins.</li>
          <li>Les dilatations des sténoses urétrales.</li>
        </ul>
      </ul>
    </div>
  </div>
