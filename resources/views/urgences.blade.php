...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/urgences.css') }}">
  </head>
  <body>
    ...
    <tr>
      ...
      <tr>
        <th scope="row">
          <a href='/urgences' class="urgences"style="color: red;">Urgences</th>
        </tr>
      </table>
      <div></div>
    </div>
    <div class="col-sm-8">
      ...
      <h4><strong>1- Accès au service des urgences médico-chirurgicales</strong></h4>
      <p>
        L’accès au service des UMC est réservé exclusivement :
      </p>
      <ol>
        <li>Aux mutations internes des patients hospitalisés dans l’un des services de l’EHUO dont l’état de santé nécessite une pris une charge en urgence</li>
        <li>Aux évacuations des malades transférés à partir des établissements publics ou privés. Les procédures d’évacuation sont décrites dans le point suivant.</li>
      </ol>
      <p>
        Les procédures relatives au plan ORSEC et les réquisitions de l’autorité judiciaire ne sont pas concernées par cette disposition.
      </p>
      <h4><strong>2- Organisation des évacuations</strong></h4>
      <ul>
        <li>L’évacuation d’un malade est décidée lorsque l’établissement hospitalier dans lequel est pris en charge un patient n’est pas en mesure de lui dispenser ni lui assurer la continuité des soins médicaux nécessaires.</li>
        <li>L’évacuation est régie par les textes réglementaires de la tutelle et obéit à des dispositions médicale et administrative précise.</li>
      </ul>
      <h5>
        <strong>a- Pour les établissements publics qui évacuent vers l’EHUO</h5>
      </strong>
      <p>
        Les dispositions médicales pour évacuer un malade sont les suivantes :
      </p>
      <ol>
        <li>Le malade est déjà inscrit sur un registre des urgences.</li>
        <li>Le malade est pris en charge et mit en condition en vue de son évacuation.</li>
        <li>L’accord de l’établissement sanitaire d’accueil demandé et obtenu et co-validé par les deux établissements : demandeur et accueil.</li>
      </ol>
      <p>
        Les dispositions administratives sont les suivantes :
      </p>
      <ol>
        <li>La fiche d’évacuation du malade est établie conjointement par le Directeur (ou son représentant dûment désigné par lui), le médecin évacuateur et/ou le surveillant médical.</li>
        <li>Le moyen d’évacuation doit être sécurisé : ambulance avec un accompagnateur médical ou à défaut paramédical.</li>
        <li>L’accord du directeur de l’EHUO ou de son représentant dûment désigné par lui est indispensable.</li>
        <li>Les procédures d’admission au niveau de l’EHUO doivent etre accomplis par les accompagnateurs du malade : le chauffeur ambulancier, le médecin ou à défaut le paramédical, avec l’assistance du personnel d’accueil de l’EHUO.</li>
      </ol>
      <p>
        Au niveau de l’EHUO :
      </p>
      <li>La fiche de réception du malade est établie conjointement par le directeur de l’EHUO (ou son représentant dûment désigné par lui), le médecin et/ou le coordinateur médical de l’EHUO en charge des urgences et de la garde.</li>
      <li>En dehors des heures de travail : le personnel de garde applique scrupuleusement les mêmes dispositions.</li>
      </br>
      <h5>
        <strong>b- Pour les établissements parapublics et privés qui évacuent vers l’EHUO<p>Les évacuations de malades doivent obéir aux dispositions suivantes :</p></h5>
      </strong>
      <ol>
        <li>L’accord préalable de l’EHUO.</li>
        <li>Le moyen d’évacuation doit être sécurisé : ambulance avec un accompagnateur médical ou à défaut paramédical.</li>
        <li>Le passage obligatoire par le service des urgences de l’EHUO.</li>
        <li>Le dossier médical complet avec tous les soins prodigués en plus des motifs d’évacuation.</li>
        <li>La fiche d’évacuation du malade est signée conjointement par le directeur médical/Responsable d’établissement parapublic, le médecin évacuateur et l’auxiliaire médical accompagnateur.</li>
        <li>En dehors des heures de travail : le personnel de garde applique scrupuleusement les mêmes dispositions.</li>
        <li>Dans le cas ou l’EHUO, procède à l’évacuation d’un de ses patients vers un autre établissement, il devra se conformer aux mêmes dispositions.</li>
      </ol>
    </div>
  </div>
</p>
