...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Réanimation médicale</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/reanimation_medicale.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/reanimationmedicale.png">
          </p>
        </div>
      </section>
      <div class="container">
          ...
          <div class="col-sm-3">
            <table class="table">
              <tr>
                ...
                <li><a href="/reanimation_medicale"class="colorsidedropdown"style="color:red;">►Réanimation médicale </a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: M.MEHALI (Profeseur)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 14 54</strong>
          </h5>
        </li>
      </ul>
      ...
      <h2><strong>Le service dispose de 05 unités :</strong></h2>
      <ul>
        <li>Unité soins intensifs neuro-métaboliques (Dr Ould Kadi)</li>
        <li>Unité soins intensifs infectieux et chimiothérapies (Dr Mechebbek)</li>
        <li>Unité soins intensifs cardio-vasculaires (Dr Chikh)</li>
        <li>Unité des post réanimés et douleur (Dr Chiali)</li>
        <li>Unité soins intensifs respiratoires ( Dr Errouane)</li>
        <li>Unité d’anesthésie réanimation en chirurgie cardiaque.</li>
      </ul>
      <p>
        <strong><h4>Notre objectif principal est une prise en charge hautement qualifié dans les domaines suivants :</h4></strong>
      </p>
      <ol>
        <h5>
          <li><strong>Réanimation neuro-métabolique qui vise :</strong></li>
        </h5>
        <ul>
          <li>Défaillances neurologiques médicales.</li>
          <li>Pathologies obstétricales aigues graves.</li>
          <li>Accident vasculaire hémorragique.</li>
          <li>Accident ischémique.</li>
          <li>Projet d’unité neuro-vasculaire.</li>
        </ul>
        <h5>
          <strong><li>Réanimation cardio-vasculaire :</li></strong>
        </h5>
        <ul>
          <li>Infarctus du myocarde.</li>
          <li>Cardiomyopathies décompensées.</li>
          <li>Embolie pulmonaire.</li>
        </ul>
        <h5>
          <strong><li>Sepsis grave qu’il soit d’origine :</li></strong>
        </h5>
        <ul>
          <li>Médical.</li>
          <li>Chirurgical.</li>
        ...
        <h5>
          <strong><li>Réflexion</li></strong>
        </h5>
        <p>
          Prise en charge de la mort encéphalique et du prélèvement d’organes.
        </p>
        <h5>
          <strong><li>Hôpital du jour et consultation</li></strong>
        </h5>
        <p>
          Sur la douleur.
        </p>
        <h5>
          <strong><li>Réanimation médicale</li></strong>
        </h5>
        <p>
          Prise en charge des détresses vitales en intra muros des services médicaux.
        </p>
        <h5>
          <strong><li>Intégration de notre équipe</li></strong>
        </h5>
        <p>
          Aux urgences médicales.
        </p>
        <h5>
          <strong><li>Techniques :</li></strong>
        </h5>
        <ul>
          <li>Hémodialyse aigue et hemo-diafiltration.</li>
          <li>Plasmaphérèse : Maladies auto immunes (Guillain Barré), (Maladie lupique)</li>
          <li>ECMO et assistance circulatoire du SDRA et décompensation cardiaque graves.</li>
        </ul>
        <h5>
          <strong><li>Sur le plan de la pédagogie et l’enseignement :</li></strong>
        </h5>
        <ul>
          <strong><li>Enseignement des 1e,2e,3e, 4e année du résidanat d’anesthésie réanimation.</li></strong>
          <strong><li>Enseignement du CES médecine d’urgence.</li></strong>
          <strong><li>Enseignement du module des urgences 6e année médicale.</li></strong>
          <strong><li>Enseignement des internes.</li></strong>
          <strong><li>Enseignement des modules de la graduation (Sémiologie et physiopathologie) 3e année.</li></strong>
          <strong><li>Enseignement para médical (ITSP) stage et formation.</li></strong>
          <strong><li>L’enseignement de para médical de l’EHU d’Oran théorie et pratique (IDE, ATS).</li></strong>
          <strong><li>Projets et travaux de recherche :</li></strong>
          <ul>
            <li>Sédation en réanimation.</li>
            <li>Plasmaphérèse et maladies auto immunes.</li>
            <li>Consultation en post réanimation.</li>
            <li>Douleur post opératoire.</li>
          </ul>
        </ul>
      </ol>
    </div>
