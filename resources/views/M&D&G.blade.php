...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/mdg.css') }}">
  </head>
  <body>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="col-sm-8">
                        <p>
                          L’EHU du 1er Novembre constituera un symbole de notre autonomie et de notre souveraineté médicale, l’ambition qui a entouré la conception, la générosité qui a accompagné les investissements à suscité une fierté qui grâce aux compétences, aux engagements et à la détermination de ses professionnels permettra de relever le défi d’une réponse à court termes aux besoins en soins spécialisés, au développement de la recherche et une formation pointu de nos futures cadres médicaux et paramédicaux.
                        </p>
                        <p>
                          La concrétisation des missions de l’EHU se fera à travers :
                        </p>
                        <ul>
                          <li>Un nouveau mode de gouvernance une démarche managériale et participative.</li>
                          <li>Un projet d’établissement qui tiendra compte :</li>
                          <ol>
                            <li>De toute les spécificités liées au statut de l’établissement.</li>
                            <li>Aux transitions épidémiologique et démographiques.</li>
                            <li>Aux objectifs de soins de haut niveau.</li>
                            <li>L’abolition des transferts à l’étranger.</li>
                            <li>Le développement de la recherche et de la formation</li>
                          </ol>
                          <li>L’organisation en pole de l’ensemble des activités.</li>
                          <li>Un système d’information moderne et efficace.</li>
                          <li>Une contractualisation avec les bailleurs de fonds.</li>
                          <li>Une contractualisation interne basés sur des contrats d’objectifs.</li>
                        </ul>
                        <p>
                          Notre finalité est de consolider le rôle de référent de l’EHU d’Oran dans la carte sanitaire régionale voir nationale tout en préservant l’accessibilité et l’équité.
                        </p>
                      </div>
                    </div>
                  </div>
