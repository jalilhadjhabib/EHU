...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/analyses.css') }}">
  </head>
  <body>
    ...
    <div class="col-sm-8">
      <h2><strong>Analyses</strong></h2>
      <ul>
        <a href="/bacteriologie"><li>Bactériologie</li></a>
        <a href="/biochimie"><li>Biochimie</li></a>
        <a href="/cytogenetique"><li>Cytogénétique et Biologie moléculaire</li></a>
        <a href="/hemobiologie"><li>Hémobiologie</li></a>
        <a href="/immunologie"><li>Immunologie</li></a>
        <a href="/pharmacologie"><li>Pharmacologie</li></a>
        <a href="/toxicologie"><li>Toxicologie</li></a>
      </ul>
    </div>
  </div>
</p>
