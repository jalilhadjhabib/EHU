...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/neurochirurgie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/neurochirurgie.png">
          </p>
        </div>
      </section>
      <div class="container">
        ...
        <tr>
          <th>
            ...
            <li><a href="/neurochirurgie"class="colorsidedropdown"style="color: red;">►Neurochirurgie</a></li>
          </div>
        </ol>
      </th>
    </tr>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: B.BELLEBNA (Professeur)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 70 51 15</strong>
          </h5>
        </li>
        <li>
          <h5>
      ...
      <p>
        Le service de neurochirurgie dispose des espaces suivants :
      </p>
      <ul>
        <li>Un service d’hospitalisation situé au 3eme étage bloc C d’hospitalisation, fait de deux ailes d’une capacité de 30 lits avec une chambre pédiatrique.</li>
        <li>Consultation et hôpital du jour : située au rez-de-chaussée du bloc de consultation.</li>
        <li>Une salle opératoire au sein du bloc opératoire central.</li>
        <li>Une salle opératoire au sein du bloc des urgences.</li>
      </ul>
      <h2><strong>Activités du service</strong></h2>
      <p>
        Le service de neurochirurgie regroupe 05 unités :
      </p>
      <ol>
        <li>Cancérologie.</li>
        <li>Stéréotaxie et endoscopie.</li>
        <li>Spinale.</li>
        <li>Fonctionnelle : prise en charge de la maladie de Parkinson.</li>
        <li>Vasculaire : traitement chirurgical des anévrysmes et des malformations artérioveineuses.</li>
      </ol>
      <img src="/images/img%20neurochi2.jpg">
      <img src="/images/imgneurochir3.jpg">
      <h2><strong>Personnel du service</strong></h2>
      <ul>
        <li>Le chef de service Pr BELLEBNA</li>
