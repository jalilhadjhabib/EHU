...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Médecine nucléaire</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/medecine_nucleaire.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/medecinenucleaire.png">
          </p>
        </div>
      </section>
      <div class="container">
      ...
      <th>
        ...
        <ol class="collapse list-unstyled" id="radiologie">
          <div class="col-sm-12">
            ...
            <li><a href="/medecine_nucleaire"class="colorsidedropdown"style="color: red;">►Médecine nucléaire</a></li>
          </div>
        </ol>
      </th>
    </tr>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>CHAKOURI.M (Maitre assistant en Biophysique médicale)</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service de biophysique et de médecine nucléaire est sis au niveau du deuxième étage du bloc exploration de l’EHU Oran à proximité du service de radiologie. Ce service assure des missions de santé bien définies selon les besoins des médecins et des patients en imagerie diagnostique, exploration biologique et une thérapeutique spécifique de certaines pathologies.
      </p>
      <h2><strong>Unité scintigraphie</strong></h2>
      <p>
        Consiste à l’introduction d’un radiotraceur dans l’organisme et recueillir une image fonctionnelle d’un organe spécifique grâce à des gamma cameras. Tous les organes peuvent être explorés : Scintigraphie thyroïdienne, osseuse, cardiaque, rénale… ces explorations scintigraphiques constituent un maillon incontournable dans le bilan fonctionnel de l’organe et l’évaluation des greffes ainsi que la diagnostique des pathologies cancéreuses et métastatiques.
      </p>
      <h2><strong>Unité laboratoire RIA</strong></h2>
      <p>
        La principale activité du laboratoire consistera aux dosages hormonaux thyroidiens : thyroglobuline plasmatique et ganglionnaire, TSHus, FT4, FT3, ANTI TPO, ANTI thyroglobuline, Calcitonine, ANTI rTSH et aussi des marqueurs tumoraux en rapport avec l’exploration scintigraphique : CA15-, CA125, CA 19-9, ACE, AFP, PSA libre et totale.
      </p>
      <h2><strong>Unité Irathérapie</strong></h2>
      <p>
        Consiste à l’hospitalisation de 3 jours dans une chambre plombée pour des patients ayant une pathologie cancéreuse thyroïdienne et à les traiter avec de l’Iode 131.
      </p>
      <p>
        Le service de biophysique et médecine nucléaire comporte :
      </p>
      <ul>
        <li>Deux gamma caméras double têtes avec collimateurs.</li>
        <li>Un appareil de mesure de fixation thyroïdienne.</li>
        <li>Un compteur gamma pour la RIA.</li>
        <li>Matériel de mesure de la radioactivité : babyline 81, activimètre, contaminométre, radiamètre.</li>
        <li>Matériel de radioprotection.</li>
      </ul>
    </div>
  </div>
</p>
