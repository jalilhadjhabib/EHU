...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Médecine physique et réadaptation</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/medecine_physique.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/medecinephysique.png">
          </p>
        </div>
      </section>
      <div class="container">
            ...
            <table class="table">
              <tr>
                <th>
                  ...
                  <li><a href="/medecine_physique"class="colorsidedropdown"style="color:red;">►Médecine physique </a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: DJAROUD Ziania (Professeur)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 13 38</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 40 22 06 79</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : djaroudziania@yahoo.fr</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le pole de médecine physique et réadaptation par sa polyvalence a pour mission de recevoir des patients présentant une limitation fonctionnelle, un déconditionnement ou un handicap.
      </p>
      <h3>Activités</h3>
      <h4>Unité ambulatoire</h4>
      <ul>
        <li>Consultation quotidiennes pluridisciplinaires.</li>
        <li>Consultation spécialisée de l'infirme moteur cerébral.</li>
        <li>Consultation de neuropsychologie.</li>
        <li>Plateaux techniques gymnase (Kinésithérapie, physiothérapie, balnéothérapie)</li>
        <li>Ergothérapie (prise en charge simultanée rééducation et réada&ptation réinsertion sociale apprentissage de l’utilisation du fauteuil roulant en milieu extérieur; sensibilisation au handicap.</li>
        <li>Evaluation et Rééducation des troubles neuropsychologiques et des troubles du langage (orthophonique), rééducation de la déglutition.</li>
      </ul>
      <h4>Unité d'hospitalisation à temps partiel</h4>
      <ul>
        <li>Evaluation et soins de la douleur (infiltration, traitement du SDRC de type 1 et 2.</li>
        <li>Traitement de fond par biothérapie des maladies rhumatismales)</li>
        <li>Rééducation psychomotricité, neuropsychologie.</li>
      </ul>
      <h4>Unité hospitalisation</h4>
      <ul>
        <li>10 lits sous unité spécifique à orientation thérapeutique et diagnostic injections de toxine botulique pour le traitement de la spasticité, les épreuves fonctionnelles et les bilans neuro-urologie, de dysfonctionnement du plancher pelvien et urétro-vésicale.</li>
        <li>10 lits sous unité spécifique à orientation neurologique, accueillant des patients atteints d’affections cérébrales et médullaires, de causes vasculaires, dégénératives...</li>
        <li>10 lits sous unité spécifique à orientation traumato orthopédique accueillant des patients porteurs d’affections de l’appareil locomoteur et d’origine dégénérative et inflammatoire (rhumatismales) ou post-traumatique complexes et invalidantes (scolioses, genou et hanche opérées chirurgie fonctionnelle du handicap du membre supérieur du tétraplégique, des troubles neuro orthopédiques, de la spasticité, chirurgie des escarres)</li>
      </ul>
      <h4>Missions en MPR</h4>
      <p>
        Présence de séquelles motrices, incapacités susceptible de s ‘améliorer, d’origine traumatologique, orthopédique, rhumatologique, pathologie touchant 1 ‘arbre respiratoire, neurologiques aigue ou dé génératives invalidantes.
      </p>
      <h4>Education thérapeutique</h4>
      <p>
        Permet aux patients d’acquérir et de conserver les capacités et compétences qui les aident à vivre de manière optimale leur vie. - capacités du patient à faire face à plusieurs heures de rééducation nécessitant donc un bon état général, et l’absence de pathologie grave intercurrente.
      </p>
    </div>
  </div>
</p>
