...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Présentation de l'EHU</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/presentation.css') }}">
  </head>
  <body>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="col-sm-8">
                        <h2><strong>Etablissement Hospitalier Universitaire d'Oran</strong></h2>
                        <p>
                          L'établissement hospitalier universitaire d’Oran, ci-après dénommé, par abréviation « EHU », est un établissement public à caractère spécifique, doté de la personnalité morale et de l’autonomie financière, sous la tutelle administrative du ministre de santé.
                          <p>
                            <p>
                              L’établissement hospitalier et universitaire (E.H.U) est organisé en structures hospitalo-universitaires créées par arrêté conjoint des ministres chargés de la santé et de l’enseignement supérieur et de la recherche scientifique.
                              <p>
                                <p>
                                  La tutelle pédagogique universitaire est assurée par le ministre chargé de l’enseignement supérieur et de la recherche scientifique.
                                </p>
                              </div>
                            </div>
                          </div>
