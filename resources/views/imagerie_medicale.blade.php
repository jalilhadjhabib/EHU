...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/imagerie_medicale.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/imageriemedicale.png">
          </p>
        </div>
      </section>
      <div class="container">
    ...
    <tr>
      <th>
        <a href="#radiologie" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"style="color: red;">Radiologie</a>
        <ol class="collapse list-unstyled" id="radiologie">
          <div class="col-sm-12">
            <li><a href="/imagerie_medicale"class="colorsidedropdown"style="color: red;">►Imagerie médicale</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Chef de service : BENACHENHOU . KH</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Activités</strong></h2>
      <p>
        Le plateau technique de l’établissement permet de réaliser tous les examens d’imagerie avec des appareils d’imagerie médicale adaptés aux exigences actuelles : Échographies  et Écho-doppler, Radiographie classiques, Scannographies 16 barrettes, Imagerie par Résonance Magnétiques (IRM).5 tesla, Radiologie Vasculaire Numérisée diagnostique  (Artériographies) et thérapeutique (Angioplastie).
      </p>
      <p>
        L’équipement et les compétences médicales permettant d’assurer une prise en charge optimale adaptée aux besoins de santé. Les examens d’imagerie demandés en urgence des services d’hospitalisation sont assurées 24H sur 24 H. Les autres examens sont programmés en fonction des indications et de la technique d’imagerie.
      </p>
      <h2><strong>Equipements</strong></h2>
      <p>
        Le service d’imagerie médicale est composé :
      </p>
      <ul>
        <li>D’équipements numériques de haute technologie.</li>
        <li>Deux salles de radiologie conventionnelles numérisées.</li>
        <li>Un mammographe.</li>
        <li>Deux salles  télécommandées entièrement numérisées de radiologie vasculaire.</li>
        <li>Salle d’imagerie vasculaire diagnostique  (artériographie) et interventionnelle (angioplastie et embolisation).</li>
        <li>Une salle de neuro radiologie.</li>
        <li>Une salle d’échographie et d’écho-doppler  qui permet de réaliser tous les examens (sauf écho cardiaque) situés dans  ce service et de manière spécifique.</li>
        <li>Échographie interventionnelle (cytoponction ponction drainage, biopsie).</li>
        <li>Échodoppler (artère rénales, vaisseaux de l’abdomen, en urgences vaisseaux périphériques et vaisseaux du cou et échodoppler) diagnostic.</li>
        <li>Un Scanner  rapide et performant  de dernière génération pour tous types  d’examens diagnostics; Sensation 16.</li>
        <li>Une imagerie par résonance magnétique IRM (1,5 Tesla) pour le diagnostic sans irradiation des maladies neurologiques, ostéo-articulaires, viscérales, pédiatriques et obstétricales.</li>
        <li>Un ostéo densitomètre.</li>
      </ul>
      <h2><strong>Pole d’imagerie aux UMC</strong></h2>
      <p>
        Une unité d’imagerie médicale est établieau niveau des urgences médico-chirurgicales comportant :
      </p>
      <ul>
        <li>Deux tables de radiologie classique.</li>
        <li>Une salle d’échographie.</li>
        <li>Un scanner (mono baratte), Somation Émotion.</li>
      </ul>
    </div>
  </div>
</p>
