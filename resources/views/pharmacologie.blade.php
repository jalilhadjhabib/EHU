...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/pharmacologie.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/pharmacologie.png">
          </p>
        </div>
      </section>
      <div class="container">
      ...
      <th>
        ...
        <ol class="collapse list-unstyled" id="analyses">
          <div class="col-sm-15">
            ...
            <li><a href="/pharmacologie"class="colorsidedropdown"style="color: red;">►Pharmacologie</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: H. TOUMI (Professeur)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 15 79</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : lnc_Th_Oran@Yahoo.Fr</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Nombre d’unités : 03 unités
      </p>
      <ul>
        <li>Unité de pharmacocinétique clinique :</li>
        <ul>
          <li>Modélisation thérapeutique.</li>
          <li>Optimisation et standardisation d’un schéma thérapeutique.</li>
          <li>Evaluation de l’effet pharmacologique des médicaments.</li>
        </ul>
        <li>Unité  de pharmacologie clinique :</li>
        <ul>
          <li>Une corrélation entre effet pharmacodynamique et la clinique ce qui permettrait d’estimer l’efficacité et le rapport bénéfice/risque.</li>
          <li>Suivie thérapeutique des malades traités par des médicaments à index Thérapeutique étroit greffe d’organe.</li>
          <li>Essais cliniques des médicaments nouveaux à marge thérapeutique faible.</li>
          <li>Évaluation clinique sur les malades.</li>
        </ul>
        <li>Unité de pharmaco surveillance :</li>
        <ul>
          <li>La recherche d’éventuelle toxicité anormale des médicaments.</li>
          <li>La recherche d’imputabilité entre  les effets indésirables et prise médicamenteuse.</li>
        </ul>
      </ul>
      <h2><strong>Les activités biologiques du service  Pharmacovigilance :</strong></h2>
      <ul>
        <li>Dosage des médicaments :</li>
        <ul>
          <li>Immunosuppresseurs : ciclosporine, tacrolimus, mycophenolate mofetil.</li>
          <li>Cardiologie : digoxine, quinidine.</li>
          <li>Neurologie : Acide valporoïque, Carbamazépine.</li>
          <li>Oncologie : Methotrexate, Imatinib.</li>
          <li>Antibiotiques : Gentamicine, Voncomyci.</li>
        </ul>
        <li>Pharmacovigilance :</li>
        <ul>
          <li>Notification des effets indésirables des médicaments.</li>
          <li>Notification des accidents thérapeutiques causés par du matériel médical.</li>
        </ul>
        <li>Missions</li>
        <ul>
          <li>Evaluation de l’activité thérapeutique des médicaments.</li>
          <li>Optimisation et standardisation des schémas thérapeutiques.</li>
          <li>Surveillance thérapeutique des malades traités par des médicaments à index thérapeutique étroit.</li>
          <li>Recherche de l’innocuité des médicaments.</li>
