...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Chirurgie maxillo faciale</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/maxillo_faciale.css') }}">
  </head>
  <body>
      ...
      <section class="jumbotron text-center">
        ...
        <div class="container">
          <p class="lead text-muted mb-0">
            <img src="/images/maxillofaciale.png">
          </p>
        </div>
      </section>
      <div class="container">
          ...
          <th>
            ...
            <ol class="collapse list-unstyled" id="chirurgie">
              <div class="col-sm-12">
                ...
                <li><a href="/maxillo_faciale"class="colorsidedropdown"style="color: red;">►Maxillo-faciale</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: BENALIAMokhtar (Chirurgien maxillofacial)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 40 23 35 60</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 15 20</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Email : docbenalia@yahoo.fr</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service est localisé au sein de l’établissement et comporte différentes unités fonctionnelles :
      </p>
      <ul>
        <li>Unités de consultations : (niveau 2 ; Aile A)</li>
        <ul>
          <li>Consultations externes de chirurgie maxillo-faciale et stomatologique.</li>
          <li>Consultation et soins dentaires spécialisés.</li>
        </ul>
        <li>Unité d’Hospitalisation</li>
        <ul>
          <li>Hospitalisation conventionnelle ou de longue durée (niveau 1, bloc A)</li>
        </ul>
        <p>
      ...
      <ul>
        <li>14 lits d’hospitalisation.</li>
        <li>1 lit d’isolement.</li>
      </ul>
      <ul>
        <li>Unité de chirurgie ambulatoire et radiologie : (bloc externe niveau 2, Aile A)</li>
      </ul>
      <ul>
        <li>Capacité : 5 boxes.</li>
        <li>Radiologie : orthopontomogramme.</li>
      </ul>
    </ul>
    <h2><strong>Missions</strong></h2>
    <p>
      Le service de stomatologie, chirurgie maxillo-faciale, plastique et reconstructrice, ayant le statut hospitalo-universitaire répond à une mission de soins à vocation régionale; étant le seul service spécialisé à l’ouest du pays et le troisième à l’échelle national est très sollicité par les différents organismes sanitaire privé ou publique de la région notamment dans le cadre de la pathologie tumorale, mal formative et traumatique.
    </p>
    <h2><strong>Activités</strong></h2>
    <p>
      Les consultations soins externes en chirurgie maxillo-faciale et dentaire :
    </p>
    <ul>
      <li>Les consultations aux heures ouvrables 8h :30 – 12h et  13h: 30 – 16h: 00 se font sur RDV  avec lettre du médecin ou chirurgien dentiste traitant.</li>
    </ul>
    <p>
      Chirurgie ambulatoire :
    </p>
    <ul>
      <li>Interventions chirurgicales nécessitant une surveillance post opératoire de quelques heures et se déroulent sous anesthésie locale et locorégionale.</li>
    </ul>
    <h2><strong>Activités d'enseignement</strong></h2>
    <ul>
      <li>
        <p>
          <strong>Poste graduation :</strong>
          se traduit par la formation des futurs chirurgiens maxillo-faciaux.
        </li>
        <p>
          Le chirurgien maxillo-facial est un médecin spécialiste ayant effectué 12 années d’études : 7 années d’étude médicale, suivies de cinq ans de résidanat au cours de la quelle il valide un tronc commun de deux années (une 1er année en chirurgie générale  et une 2eme année en  traumatologie orthopédie et chirurgie pédiatrique) avec des stages en neurochirurgie, ORL et chirurgie thoracique.
        </p>
        <li>
          <p>
            <strong>Graduation :</strong>
            Le service assure régulièrement la formation des internes en médecine dans le cadre de leur stage de chirurgie.
          </li>
        </ul>
      </div>
    </div>
...
<footer class="text-light"><div class="container">
  <div class="row">
    <div class="col-md-3 col-lg-4 col-xl-5">
      ...
      <p class="mb-0">
        L'établissement hospitalier universitaire, connu sous le nom de l'EHU, est un hôpital universitaire créé en 2012, qui qui est situé à Oran.
      </p>
    </div>
