...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Chirurgie cardiaque</title>
    <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/cardiaque.css') }}">
  </head>
  <body>
        ...
        <tr>
          <th>
            ...
            <ol class="collapse list-unstyled" id="chirurgie">
              <div class="col-sm-12">
                <li><a href="/cardiaque"class="colorsidedropdown"style="color: red;">►Cardiaque</a></li>
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service: Pr ATBI (Professeur)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Fonction : Chirurgien Cardio-vasculaire</strong>
          </h5>
        </li>
      </ul>
      <p>
        Le service de Chirurgie Cardiaque a débuté son activité le 23 Novembre 2008.
      </p>
      <p>
        Le service de Chirurgie Cardiaque de I’EHU D’Oran s’est installé au 04 ème étage du bloc A de l’EHU. Il comprend 32 lits d’hospitalisation répartis en 02 unités; et une unité de réanimation de Chirurgie Cardiaque de 08 lits.
      </p>
      <h2><strong>Missions</strong></h2>
      <h4>La chirurgie cardiaque, réalisée à l‘EHU Oran, prend en charge toute la pathologie cardiaque acquise et congénitale de l’adulte :</h4>
      <ul>
        <li>Pathologie valvulaire :</li>
        <ul>
          <li>Chirurgie valvulaire mitrale : réparation et remplacement.</li>
          <li>Chirurgie valvulaire aortique : remplacement sous CEC.</li>
        </ul>
        <li>Pathologies coronariennes :</li>
        <ul>
          <li>Pontage aorto-coronaire sous circulation extracorporelle.</li>
        </ul>
        <li>Chirurgie des Tumeurs Cardiaques :</li>
        <ul>
          <li>Myxomes, Kyste Hydatique, etc.</li>
        </ul>
        <li>Chirurgie valvulaire aortique : remplacement sous CEC</li>
        <li>Chirurgie Congénitale :</li>
        <ul>
          <li>CIA, PCA, Sténose Aortique Congénitale, etc.</li>
        </ul>
        <li>Pathologie Tricuspide.</li>
        <li>Urgences:Thrombose de Valve, Plaies Cardiaques, Epanchements péricardiques, etc.</li>
      </ul>
      <h2><strong>Praticiens</strong></h2>
      <ul>
        <li>Dr HAMOUDA.</li>
        <li>Dr LARABI.</li>
        <li>Dr DJILALI.</li>
        <li>Dr BOUCHENAFA.</li>
        <li>Dr BOUKLI.</li>
        <li>Dr OULD ABDERRAHMANE.</li>
        <li>Dr HAMDI.</li>
        <li>Dr AMIR.</li>
      </ul>
      <h2><strong>Cardiologue</strong></h2>
      <ul>
        <li>Dr LARBI.</li>
      </ul>
    </div>
