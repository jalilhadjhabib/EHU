...
<html lang="en" data-theme="light">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/maternite.css') }}">
  </head>
  <body>
    ...
    <tr>
      <th scope="row">
        <a href='/maternite' class="maternite"style="color: red;">Maternité</th>
      </tr>
      <tr>
        <th scope="row">
    ...
    <div class="col-sm-8">
      <ul>
        <li>
          <h5>
            <strong>Chef de service : CHAFI  BELKACEM (Professeur)</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>Tél / fax : (+213) 41 42 15 23</strong>
          </h5>
        </li>
        <li>
          <h5>
            <strong>E-mail : chafkacem@yahoo.fr</strong>
          </h5>
        </li>
      </ul>
      <h2><strong>Présentation du service</strong></h2>
      <p>
        Le service de  Gynécologie - obstétrique  appelé faussement « MATERNITÉ » abrite en son sein une spécialité Médico - Chirurgicale correspondant en fait à 2 spécialités bien distinctes :
      </p>
      <ul>
        <li><strong>L’Obstétrique :</strong> qui prend en charge la surveillance de la grossesse, l’accouchement, l’accueil du nouveau-né, sa réanimation et son élevage au moins pendant sa période Périnatale.</li>
        <li><strong>La Gynécologie :</strong> qui prend en charge toutes les pathologies des organes génitaux féminins et des seins. Selon le statut de l’EHU, cette P.E.C (prise en charge) doit être du niveau le plus élevé, c’est-à-dire du niveau III.</li>
        <li><strong>Rez de chaussé :</strong> qui se compose de : (12 lits HDJ)</li>
        <li><strong>1er étage :</strong> Unité GHR + unité de néonatologie + blocs opératoires.</li>
        <li><strong>2e  étage :</strong> Unité de gynécologie  et oncologie chirurgicale. (27 lits)</li>
      </ul>
      <h4>Unité de consultation externe et exploration</h4>
      <p>
        1er étage bloc A de la consultation
      </p>
      <ul>
        <li>Consultation spécialisées gynécologiques – psychologique – PMI- pédiatrique.</li>
        <li>Exploration : échographie – colposcopie  FCV – HPV (TYPAGE) – doptone.</li>
        <li>Unité de dépistage : cancer du col et du sein.</li>
      </ul>
      <h4>1- Missions pédagogiques :</h4>
      <p>
        - Enseignement médical.
      </p>
      <p>
        - Post-graduation : Professeurs-Docent-Maître–assistants-Résidents.
      </p>
      <p>
        - Graduation : Internes-Externes.
      </p>
      <h4>2- Missions de formation:</h4>
      <p>
        Formation paramédicale :Sage-femme, Infirmières-Laborantins,  Assistantes  sociales.
      </p>
      <p>
        Secrétaires  médicaux.
      </p>
      <p>
        Formation  universitaire : psychologues-Pharmaciens.
      </p>
      <h4>3- Missions de recherche :</h4>
      <ul>
        <li>Etudes Statistiques.</li>
        <li>Recherche épidémiologique.</li>
        <li>Etudes analytiques des résultats des PEC.</li>
        <li>Etudes de protocoles et Exécution de protocoles.</li>
        <li>Réalisation des projets de recherche (ANDRS, FACULTE, AUTRES…)</li>
      </ul>
      <p>
        Ces missions sont réalisées au sein du service, pour le service ou en collaboration avec d’autres services ou d’autres facultés.
      </p>
      <h4>4- Missions sanitaires :</h4>
      <ul>
        <li>Soins curatifs PEC des patientes (f. en activité génitale, ménopause, Adolescentes, à la puberté +14 ans).</li>
        <li>Soins  Investigations +/- Explorations.</li>
        <li>Soins obstétricaux (GHR, Acct, César).</li>
        <li>Soins curatifs PEC des nouveau-nés (Accueil à la naissance, réanimation, élevage des prématurés, Allaitement..).</li>
      </ul>
      <h2><strong>Effectif du service :</strong></h2>
      <h4>1) Personnel médical </h4>
      <div align="justify" class="tabtest">
        <table width="755" border="0" cellpadding="0" cellspacing="0" >
          <tbody>
            <tr>
              <td width="113" height="5" valign="middle"  class="text">
              ...
              <td width="119" valign="middle"  class="text">
                <p align="center" class="Style21">
                  <strong>Maitre assistant</strong>
                </p>
              </td>
              <td width="205" valign="middle"  class="text">
                <p align="center" class="Style21">
                  <strong>Santé publique</strong>
                </p>
              </td>
              <td width="150" valign="middle"  class="text">
                <p align="center" class="Style21">
                  <strong>Résident</strong>
                </p>
              </td>
              <td width="121" valign="middle"  class="text">
                <p align="center" class="Style21">
                  <strong>Réa.</strong>
                </p>
              </td>
            ...
            <tr>
              <td width="113" valign="top"  class="text">
                <p align="center">
                  01
                </p>
              </td>
              <td width="69" valign="top"  class="text">
                <p align="center">
                  00
                </p>
              </td>
              <td width="119" valign="top"  class="text">
                <p align="center">
                  03
                </p>
              </td>
              <td width="205" valign="top" class="text">
                <p align="center">
                  <04 assist.GYN.OBS
                  <br />
                  01 chirurgie infantile 
                  <br />
                  02 pédiatres 
                  <br />
                  01 andrologue 
              ...
              <td width="121" valign="top"  class="text">
                <p align="center">
                  00
                </p>
              </td>
      ...
      <h4>2) Paramédicaux </h4>
      <div align="justify" class="tabtest">
        <table width="747" border="0" cellpadding="0" cellspacing="0">
          <tbody>
            <tr>
              <td width="152" align="center" valign="top"  class="text">
                <span class="Style21" style="font-size:20px"><strong>Sage femme</strong></span>
              </td>
              <td width="152" align="center" valign="middle"  class="text">
                <p align="center" class="Style21">
                  <strong>AMAR</strong>
                </p>
              </td>
              <td width="112" align="center" valign="middle"  class="text">
                <p align="center" class="Style21">
                  <strong>Puéricultrices </strong>
                </p>
              </td>
              <td width="151" align="center" valign="middle"  class="text">
                <p align="center" class="Style21">
                  <strong>IDE</strong>
                </p>
              </td>
              ...
              <td width="114" align="center" valign="middle"  class="text">
                <p align="center" class="Style21">
                  <strong>IB</strong>
                </p>
              </td>
            ...
            <tr>
              <td width="112" valign="middle"  class="text">
                <p align="center">
                  29
                </p>
              </td>
              <td width="152" valign="middle"  class="text">
                <p align="center">
                  04 détachés
                  <br />
                  +03 affectés 
              ...
              <td width="151" valign="middle"  class="text">
                <p align="center">
                  02 détachées
                </p>
              </td>
              <td width="106" valign="middle"  class="text">
                <p align="center">
                  02
                </p>
              </td>
              <td width="114" valign="middle"  class="text">
                <p align="center">
                  03
                </p>
              </td>
